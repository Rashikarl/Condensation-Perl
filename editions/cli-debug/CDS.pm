...
#line 2 "Condensation/File.pm"
# File system utility functions.

#line 4 "Condensation/File.pm"
...
#line 12 "Condensation/MinMax.pm"
sub max {
	my $class = shift;
...
#line 21 "Condensation/MinMax.pm"
sub booleanCompare {
	my $class = shift;
	my $a = shift;
	my $b = shift;
...
#line 11 "Condensation/Random.pm"
sub randomBytes {
	my $class = shift;
	my $length = shift;
...
#line 15 "Condensation/Random.pm"
sub randomKey {
	my $class = shift;
...
#line 5 "Condensation/Actors/OpenEnvelope.pm"
...
#line 1 "Condensation/CLI/AccountToken.pm"
# The result of parsing an ACCOUNT token (see Token.pm).
package CDS::AccountToken;

#line 3 "Condensation/CLI/AccountToken.pm"
sub new {
	my $class = shift;
	my $cliStore = shift;
...
#line 20 "Condensation/Actors/ActorGroup.pm"
sub members {
	my $o = shift;
	 @{$o->{members}} }
...
#line 1 "Condensation/Actors/ActorGroup/EntrustedActor.pm"
...
#line 1 "Condensation/Actors/ActorGroup/Member.pm"
...
#line 4 "Condensation/Actors/ActorGroupBuilder.pm"
sub new {
	my $class = shift;
...
#line 13 "Condensation/Actors/ActorGroupBuilder.pm"
sub members {
	my $o = shift;
	 values %{$o->{members}} }
sub entrustedActorsRevision { shift->{entrustedActorsRevision} }
...
#line 18 "Condensation/Actors/ActorGroupBuilder.pm"
...
#line 22 "Condensation/Actors/ActorGroupBuilder.pm"
sub addMember {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $storeUrl = shift;
...
#line 30 "Condensation/Actors/ActorGroupBuilder.pm"
sub removeMember {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $storeUrl = shift;
...
#line 35 "Condensation/Actors/ActorGroupBuilder.pm"
sub parseMembers {
	my $o = shift;
...
#line 51 "Condensation/Actors/ActorGroupBuilder.pm"
...
#line 58 "Condensation/Actors/ActorGroupBuilder.pm"
...
#line 63 "Condensation/Actors/ActorGroupBuilder.pm"
...
#line 67 "Condensation/Actors/ActorGroupBuilder.pm"
...
#line 74 "Condensation/Actors/ActorGroupBuilder.pm"
...
#line 86 "Condensation/Actors/ActorGroupBuilder.pm"
sub parse {
	my $o = shift;
	my $record = shift; die 'wrong type '.ref($record).' for $record' if defined $record && ref $record ne 'CDS::Record';
	my $linkedPublicKeys = shift;
...
#line 91 "Condensation/Actors/ActorGroupBuilder.pm"
sub load {
	my $o = shift;
	my $store = shift;
...
#line 95 "Condensation/Actors/ActorGroupBuilder.pm"
sub discover {
	my $o = shift;
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
	my $delegate = shift;
...
#line 133 "Condensation/Actors/ActorGroupBuilder.pm"
sub toRecord {
	my $o = shift;
	my $linkedPublicKeys = shift;
...
#line 139 "Condensation/Actors/ActorGroupBuilder.pm"
...
#line 1 "Condensation/Actors/ActorGroupBuilder/EntrustedActor.pm"
...
#line 1 "Condensation/Actors/ActorGroupBuilder/Member.pm"
...
#line 1 "Condensation/CLI/ActorGroupToken.pm"
# The result of parsing an ACTORGROUP token (see Token.pm).
package CDS::ActorGroupToken;

#line 3 "Condensation/CLI/ActorGroupToken.pm"
sub new {
	my $class = shift;
	my $label = shift;
...
#line 1 "Condensation/Actors/ActorOnStore.pm"
# A public key and a store.
package CDS::ActorOnStore;

#line 3 "Condensation/Actors/ActorOnStore.pm"
sub new {
	my $class = shift;
	my $publicKey = shift; die 'wrong type '.ref($publicKey).' for $publicKey' if defined $publicKey && ref $publicKey ne 'CDS::PublicKey';
	my $store = shift;
...
#line 13 "Condensation/Actors/ActorOnStore.pm"
sub equals {
	my $this = shift;
	my $that = shift;
...
#line 1 "Condensation/CLI/BoxToken.pm"
# The result of parsing a BOX token (see Token.pm).
package CDS::BoxToken;

#line 3 "Condensation/CLI/BoxToken.pm"
sub new {
	my $class = shift;
...
#line 1 "Condensation/CLI/CLI.pm"
package CDS::CLI;

sub run {
	my $class = shift;

#line 2 "Condensation/CLI/CLI.pm"
	my $isTTY = -t STDOUT;
	my $isCompletion = exists $ENV{COMP_LINE};
	my $ui = CDS::UI->new(*STDOUT, $isCompletion || ! $isTTY);

#line 6 "Condensation/CLI/CLI.pm"
...
#line 13 "Condensation/CLI/CLI.pm"
...
#line 44 "Condensation/CLI/CLI.pm"
	if ($isCompletion) {
...
#line 56 "Condensation/CLI/CLI.pm"
	return 0;
}

#line 59 "Condensation/CLI/CLI.pm"
sub new {
	my $class = shift;
	my $actor = shift;

#line 60 "Condensation/CLI/CLI.pm"
	return bless {actor => $actor};
}

#line 63 "Condensation/CLI/CLI.pm"
sub default {
	my $o = shift;
	my $cmd = shift;

#line 64 "Condensation/CLI/CLI.pm"
	my $ui = $o->{actor}->ui;

#line 66 "Condensation/CLI/CLI.pm"
	# Version
	$ui->space;
	$ui->title('Condensation CLI');
	$ui->line('Version ', $CDS::VERSION, ', ', $CDS::releaseDate, '.');

#line 71 "Condensation/CLI/CLI.pm"
	# Welcome message
...
#line 7 "Condensation/CLI/CLIActor.pm"
sub open {
	my $class = shift;
...
#line 55 "Condensation/CLI/CLIActor.pm"
sub saveOrShowError {
	my $o = shift;
...
#line 64 "Condensation/CLI/CLIActor.pm"
sub onMissingObject {
	my $o = shift;
...
#line 74 "Condensation/CLI/CLIActor.pm"
...
#line 82 "Condensation/CLI/CLIActor.pm"
...
#line 94 "Condensation/CLI/CLIActor.pm"
...
#line 98 "Condensation/CLI/CLIActor.pm"
...
#line 106 "Condensation/CLI/CLIActor.pm"
...
#line 112 "Condensation/CLI/CLIActor.pm"
...
#line 124 "Condensation/CLI/CLIActor.pm"
sub storeForUrl {
	my $o = shift;
	my $url = shift;
...
#line 1 "Condensation/CLI/CLIStoreManager.pm"
...
#line 11 "Condensation/Stores/CheckSignatureStore.pm"
sub get {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 16 "Condensation/Stores/CheckSignatureStore.pm"
sub book {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 20 "Condensation/Stores/CheckSignatureStore.pm"
sub put {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $object = shift; die 'wrong type '.ref($object).' for $object' if defined $object && ref $object ne 'CDS::Object';
...
#line 25 "Condensation/Stores/CheckSignatureStore.pm"
sub list {
	my $o = shift;
...
#line 29 "Condensation/Stores/CheckSignatureStore.pm"
sub add {
	my $o = shift;
	my $accountHash = shift; die 'wrong type '.ref($accountHash).' for $accountHash' if defined $accountHash && ref $accountHash ne 'CDS::Hash';
	my $boxLabel = shift;
...
#line 33 "Condensation/Stores/CheckSignatureStore.pm"
sub remove {
	my $o = shift;
	my $accountHash = shift; die 'wrong type '.ref($accountHash).' for $accountHash' if defined $accountHash && ref $accountHash ne 'CDS::Hash';
	my $boxLabel = shift;
...
#line 37 "Condensation/Stores/CheckSignatureStore.pm"
sub modify {
	my $o = shift;
...
#line 1 "Condensation/CLI/Commands/ActorGroup.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::ActorGroup;

#line 3 "Condensation/CLI/Commands/ActorGroup.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 47 "Condensation/CLI/Commands/ActorGroup.pm"
sub collectAccount {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 51 "Condensation/CLI/Commands/ActorGroup.pm"
sub collectActive {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 55 "Condensation/CLI/Commands/ActorGroup.pm"
sub collectActor {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 59 "Condensation/CLI/Commands/ActorGroup.pm"
sub collectActor1 {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 63 "Condensation/CLI/Commands/ActorGroup.pm"
sub collectBackup {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 67 "Condensation/CLI/Commands/ActorGroup.pm"
sub collectIdle {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 71 "Condensation/CLI/Commands/ActorGroup.pm"
sub collectRevoked {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 75 "Condensation/CLI/Commands/ActorGroup.pm"
sub collectStore {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 80 "Condensation/CLI/Commands/ActorGroup.pm"
sub new {
	my $class = shift;
	my $actor = shift;
...
#line 111 "Condensation/CLI/Commands/ActorGroup.pm"
sub show {
	my $o = shift;
	my $cmd = shift;
...
#line 127 "Condensation/CLI/Commands/ActorGroup.pm"
sub type {
	my $o = shift;
	my $actorSelector = shift; die 'wrong type '.ref($actorSelector).' for $actorSelector' if defined $actorSelector && ref $actorSelector ne 'CDS::Selector';
...
#line 139 "Condensation/CLI/Commands/ActorGroup.pm"
sub coloredType7 {
	my $o = shift;
	my $actorSelector = shift; die 'wrong type '.ref($actorSelector).' for $actorSelector' if defined $actorSelector && ref $actorSelector ne 'CDS::Selector';
...
#line 151 "Condensation/CLI/Commands/ActorGroup.pm"
sub joinMember {
	my $o = shift;
	my $cmd = shift;
...
#line 190 "Condensation/CLI/Commands/ActorGroup.pm"
sub setFlag {
	my $o = shift;
	my $actorSelector = shift; die 'wrong type '.ref($actorSelector).' for $actorSelector' if defined $actorSelector && ref $actorSelector ne 'CDS::Selector';
	my $label = shift;
...
#line 199 "Condensation/CLI/Commands/ActorGroup.pm"
sub setMember {
	my $o = shift;
	my $cmd = shift;
...
#line 1 "Condensation/CLI/Commands/Announce.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::Announce;

#line 3 "Condensation/CLI/Commands/Announce.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 54 "Condensation/CLI/Commands/Announce.pm"
sub collectAccount {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 58 "Condensation/CLI/Commands/Announce.pm"
sub collectActive {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 62 "Condensation/CLI/Commands/Announce.pm"
sub collectActor {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 66 "Condensation/CLI/Commands/Announce.pm"
sub collectActor1 {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 70 "Condensation/CLI/Commands/Announce.pm"
...
#line 74 "Condensation/CLI/Commands/Announce.pm"
sub collectIdle {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 78 "Condensation/CLI/Commands/Announce.pm"
sub collectKeypair {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 82 "Condensation/CLI/Commands/Announce.pm"
sub collectRevoked {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 86 "Condensation/CLI/Commands/Announce.pm"
sub collectStore {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 90 "Condensation/CLI/Commands/Announce.pm"
sub collectStore1 {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 99 "Condensation/CLI/Commands/Announce.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 122 "Condensation/CLI/Commands/Announce.pm"
sub announceMe {
	my $o = shift;
	my $cmd = shift;
...
#line 128 "Condensation/CLI/Commands/Announce.pm"
sub announceOnStore {
	my $o = shift;
	my $store = shift;
...
#line 137 "Condensation/CLI/Commands/Announce.pm"
sub announceKeyPair {
	my $o = shift;
	my $cmd = shift;
...
#line 208 "Condensation/CLI/Commands/Announce.pm"
sub readCard {
	my $o = shift;
...
#line 226 "Condensation/CLI/Commands/Announce.pm"
sub applyChanges {
	my $o = shift;
	my $actorGroup = shift; die 'wrong type '.ref($actorGroup).' for $actorGroup' if defined $actorGroup && ref $actorGroup ne 'CDS::ActorGroup';
	my $status = shift;
...
#line 232 "Condensation/CLI/Commands/Announce.pm"
sub announce {
	my $o = shift;
	my $card = shift;
...
#line 1 "Condensation/CLI/Commands/Book.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::Book;

#line 3 "Condensation/CLI/Commands/Book.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 26 "Condensation/CLI/Commands/Book.pm"
sub collectHash {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 30 "Condensation/CLI/Commands/Book.pm"
sub collectObject {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 34 "Condensation/CLI/Commands/Book.pm"
sub collectStore {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 38 "Condensation/CLI/Commands/Book.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 56 "Condensation/CLI/Commands/Book.pm"
sub book {
	my $o = shift;
	my $cmd = shift;
...
#line 88 "Condensation/CLI/Commands/Book.pm"
sub process {
	my $o = shift;
	my $store = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
...
#line 1 "Condensation/CLI/Commands/CheckKeyPair.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::CheckKeyPair;

#line 3 "Condensation/CLI/Commands/CheckKeyPair.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 32 "Condensation/CLI/Commands/CheckKeyPair.pm"
sub collectFile {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 36 "Condensation/CLI/Commands/CheckKeyPair.pm"
sub collectFile1 {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 41 "Condensation/CLI/Commands/CheckKeyPair.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 55 "Condensation/CLI/Commands/CheckKeyPair.pm"
sub checkKeyPair {
	my $o = shift;
	my $cmd = shift;
...
#line 1 "Condensation/CLI/Commands/CollectGarbage.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::CollectGarbage;

#line 3 "Condensation/CLI/Commands/CollectGarbage.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 28 "Condensation/CLI/Commands/CollectGarbage.pm"
sub collectStore {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 32 "Condensation/CLI/Commands/CollectGarbage.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 55 "Condensation/CLI/Commands/CollectGarbage.pm"
sub collectGarbage {
	my $o = shift;
	my $cmd = shift;
...
#line 60 "Condensation/CLI/Commands/CollectGarbage.pm"
sub wrapUpDeletion {
	my $o = shift;
	 }

#line 62 "Condensation/CLI/Commands/CollectGarbage.pm"
sub reportGarbage {
	my $o = shift;
	my $cmd = shift;
...
#line 227 "Condensation/CLI/Commands/CollectGarbage.pm"
sub traverse {
	my $o = shift;
	my $hashBytes = shift;
	my $origin = shift;
...
#line 247 "Condensation/CLI/Commands/CollectGarbage.pm"
sub readIndex {
	my $o = shift;
...
#line 256 "Condensation/CLI/Commands/CollectGarbage.pm"
sub index {
	my $o = shift;
	my $hashBytes = shift;
	my $origin = shift;
...
#line 299 "Condensation/CLI/Commands/CollectGarbage.pm"
...
#line 312 "Condensation/CLI/Commands/CollectGarbage.pm"
sub startProgress {
	my $o = shift;
	my $title = shift;
...
#line 318 "Condensation/CLI/Commands/CollectGarbage.pm"
...
#line 324 "Condensation/CLI/Commands/CollectGarbage.pm"
sub lastModified {
	my $file = shift;
...
#line 1 "Condensation/CLI/Commands/CollectGarbage/Delete.pm"
...
#line 11 "Condensation/CLI/Commands/CollectGarbage/Delete.pm"
sub initialize {
	my $o = shift;
	my $folder = shift;
	 1 }

#line 13 "Condensation/CLI/Commands/CollectGarbage/Delete.pm"
sub startDeletion {
	my $o = shift;
...
#line 17 "Condensation/CLI/Commands/CollectGarbage/Delete.pm"
sub deleteEnvelope {
	my $o = shift;
	my $file = shift;
	 $o->deleteObject($file) }

#line 19 "Condensation/CLI/Commands/CollectGarbage/Delete.pm"
sub deleteObject {
	my $o = shift;
	my $file = shift;
...
#line 24 "Condensation/CLI/Commands/CollectGarbage/Delete.pm"
sub wrapUp {
	my $o = shift;
	 }

#line 1 "Condensation/CLI/Commands/CollectGarbage/Report.pm"
...
#line 12 "Condensation/CLI/Commands/CollectGarbage/Report.pm"
sub initialize {
	my $o = shift;
...
#line 18 "Condensation/CLI/Commands/CollectGarbage/Report.pm"
sub startDeletion {
	my $o = shift;
...
#line 22 "Condensation/CLI/Commands/CollectGarbage/Report.pm"
sub deleteEnvelope {
	my $o = shift;
	my $file = shift;
	 $o->deleteObject($file) }

#line 24 "Condensation/CLI/Commands/CollectGarbage/Report.pm"
sub deleteObject {
	my $o = shift;
	my $file = shift;
...
#line 32 "Condensation/CLI/Commands/CollectGarbage/Report.pm"
sub wrapUp {
	my $o = shift;
...
#line 1 "Condensation/CLI/Commands/CreateKeyPair.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::CreateKeyPair;

#line 3 "Condensation/CLI/Commands/CreateKeyPair.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 20 "Condensation/CLI/Commands/CreateKeyPair.pm"
sub collectFilename {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 24 "Condensation/CLI/Commands/CreateKeyPair.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 44 "Condensation/CLI/Commands/CreateKeyPair.pm"
sub createKeyPair {
	my $o = shift;
	my $cmd = shift;
...
#line 1 "Condensation/CLI/Commands/Curl.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::Curl;

#line 3 "Condensation/CLI/Commands/Curl.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 135 "Condensation/CLI/Commands/Curl.pm"
sub collectActor {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 139 "Condensation/CLI/Commands/Curl.pm"
sub collectActor1 {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 143 "Condensation/CLI/Commands/Curl.pm"
sub collectAnd {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 152 "Condensation/CLI/Commands/Curl.pm"
sub collectFile {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 156 "Condensation/CLI/Commands/Curl.pm"
sub collectFile1 {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 160 "Condensation/CLI/Commands/Curl.pm"
sub collectHash {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 164 "Condensation/CLI/Commands/Curl.pm"
sub collectHash1 {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 168 "Condensation/CLI/Commands/Curl.pm"
sub collectHash2 {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 172 "Condensation/CLI/Commands/Curl.pm"
sub collectKeypair {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 176 "Condensation/CLI/Commands/Curl.pm"
sub collectMessages {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 180 "Condensation/CLI/Commands/Curl.pm"
...
#line 184 "Condensation/CLI/Commands/Curl.pm"
sub collectObject {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 189 "Condensation/CLI/Commands/Curl.pm"
sub collectPrivate {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 193 "Condensation/CLI/Commands/Curl.pm"
sub collectPrivate1 {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 197 "Condensation/CLI/Commands/Curl.pm"
sub collectPublic {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 201 "Condensation/CLI/Commands/Curl.pm"
sub collectPublic1 {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 205 "Condensation/CLI/Commands/Curl.pm"
sub collectStore {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 209 "Condensation/CLI/Commands/Curl.pm"
sub collectWatch {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 213 "Condensation/CLI/Commands/Curl.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 255 "Condensation/CLI/Commands/Curl.pm"
sub curlGet {
	my $o = shift;
	my $cmd = shift;
...
#line 264 "Condensation/CLI/Commands/Curl.pm"
sub curlPut {
	my $o = shift;
	my $cmd = shift;
...
#line 275 "Condensation/CLI/Commands/Curl.pm"
sub curlBook {
	my $o = shift;
	my $cmd = shift;
...
#line 284 "Condensation/CLI/Commands/Curl.pm"
sub curlList {
	my $o = shift;
	my $cmd = shift;
...
#line 296 "Condensation/CLI/Commands/Curl.pm"
sub curlModify {
	my $o = shift;
	my $cmd = shift;
...
#line 343 "Condensation/CLI/Commands/Curl.pm"
sub curlRequest {
	my $o = shift;
	my $method = shift;
	my $url = shift;
...
#line 403 "Condensation/CLI/Commands/Curl.pm"
...
#line 1 "Condensation/CLI/Commands/DiscoverActorGroup.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::DiscoverActorGroup;

#line 3 "Condensation/CLI/Commands/DiscoverActorGroup.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 43 "Condensation/CLI/Commands/DiscoverActorGroup.pm"
sub collectAccount {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 47 "Condensation/CLI/Commands/DiscoverActorGroup.pm"
sub collectActor {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 51 "Condensation/CLI/Commands/DiscoverActorGroup.pm"
...
#line 55 "Condensation/CLI/Commands/DiscoverActorGroup.pm"
...
#line 60 "Condensation/CLI/Commands/DiscoverActorGroup.pm"
sub collectKeypair {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 64 "Condensation/CLI/Commands/DiscoverActorGroup.pm"
sub collectMe {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 68 "Condensation/CLI/Commands/DiscoverActorGroup.pm"
sub collectStore {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 72 "Condensation/CLI/Commands/DiscoverActorGroup.pm"
sub collectText {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 76 "Condensation/CLI/Commands/DiscoverActorGroup.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 108 "Condensation/CLI/Commands/DiscoverActorGroup.pm"
sub discover {
	my $o = shift;
	my $cmd = shift;
...
#line 162 "Condensation/CLI/Commands/DiscoverActorGroup.pm"
sub prepareBuilder {
	my $o = shift;
...
#line 189 "Condensation/CLI/Commands/DiscoverActorGroup.pm"
...
#line 195 "Condensation/CLI/Commands/DiscoverActorGroup.pm"
sub showActorGroup {
	my $o = shift;
	my $actorGroup = shift; die 'wrong type '.ref($actorGroup).' for $actorGroup' if defined $actorGroup && ref $actorGroup ne 'CDS::ActorGroup';
...
#line 218 "Condensation/CLI/Commands/DiscoverActorGroup.pm"
...
#line 222 "Condensation/CLI/Commands/DiscoverActorGroup.pm"
...
#line 226 "Condensation/CLI/Commands/DiscoverActorGroup.pm"
...
#line 230 "Condensation/CLI/Commands/DiscoverActorGroup.pm"
...
#line 1 "Condensation/CLI/Commands/EntrustedActors.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::EntrustedActors;

#line 3 "Condensation/CLI/Commands/EntrustedActors.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 46 "Condensation/CLI/Commands/EntrustedActors.pm"
sub collectAccount {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 50 "Condensation/CLI/Commands/EntrustedActors.pm"
sub collectActor {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 54 "Condensation/CLI/Commands/EntrustedActors.pm"
sub collectActor1 {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 58 "Condensation/CLI/Commands/EntrustedActors.pm"
sub collectActor2 {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 62 "Condensation/CLI/Commands/EntrustedActors.pm"
sub collectStore {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 67 "Condensation/CLI/Commands/EntrustedActors.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 90 "Condensation/CLI/Commands/EntrustedActors.pm"
sub show {
	my $o = shift;
	my $cmd = shift;
...
#line 104 "Condensation/CLI/Commands/EntrustedActors.pm"
sub entrust {
	my $o = shift;
	my $cmd = shift;
...
#line 142 "Condensation/CLI/Commands/EntrustedActors.pm"
sub doNotEntrust {
	my $o = shift;
	my $cmd = shift;
...
#line 163 "Condensation/CLI/Commands/EntrustedActors.pm"
...
#line 6 "Condensation/CLI/Commands/FolderStore.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 151 "Condensation/CLI/Commands/FolderStore.pm"
sub collectAccount {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 155 "Condensation/CLI/Commands/FolderStore.pm"
sub collectActor {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 159 "Condensation/CLI/Commands/FolderStore.pm"
...
#line 163 "Condensation/CLI/Commands/FolderStore.pm"
...
#line 167 "Condensation/CLI/Commands/FolderStore.pm"
sub collectGroup {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 171 "Condensation/CLI/Commands/FolderStore.pm"
sub collectHash {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 175 "Condensation/CLI/Commands/FolderStore.pm"
sub collectKeypair {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 179 "Condensation/CLI/Commands/FolderStore.pm"
sub collectObject {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 183 "Condensation/CLI/Commands/FolderStore.pm"
...
#line 187 "Condensation/CLI/Commands/FolderStore.pm"
sub collectStore {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 191 "Condensation/CLI/Commands/FolderStore.pm"
sub collectStore1 {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 195 "Condensation/CLI/Commands/FolderStore.pm"
sub collectText {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 199 "Condensation/CLI/Commands/FolderStore.pm"
sub collectUser {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 203 "Condensation/CLI/Commands/FolderStore.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 261 "Condensation/CLI/Commands/FolderStore.pm"
sub createStore {
	my $o = shift;
	my $cmd = shift;
...
#line 313 "Condensation/CLI/Commands/FolderStore.pm"
...
#line 338 "Condensation/CLI/Commands/FolderStore.pm"
sub showPermissions {
	my $o = shift;
	my $cmd = shift;
...
#line 345 "Condensation/CLI/Commands/FolderStore.pm"
sub showStore {
	my $o = shift;
	my $folderStore = shift;
...
#line 352 "Condensation/CLI/Commands/FolderStore.pm"
sub setPermissions {
	my $o = shift;
	my $cmd = shift;
...
#line 367 "Condensation/CLI/Commands/FolderStore.pm"
...
#line 381 "Condensation/CLI/Commands/FolderStore.pm"
sub fixPermissions {
	my $o = shift;
	my $cmd = shift;
...
#line 395 "Condensation/CLI/Commands/FolderStore.pm"
sub traversalFailed {
	my $o = shift;
	my $folderStore = shift;
...
#line 408 "Condensation/CLI/Commands/FolderStore.pm"
sub addAccount {
	my $o = shift;
	my $cmd = shift;
...
#line 428 "Condensation/CLI/Commands/FolderStore.pm"
sub publicKey {
	my $o = shift;
...
#line 440 "Condensation/CLI/Commands/FolderStore.pm"
sub removeAccount {
	my $o = shift;
	my $cmd = shift;
...
#line 459 "Condensation/CLI/Commands/FolderStore.pm"
...
#line 1 "Condensation/CLI/Commands/FolderStore/CheckLogger.pm"
package CDS::Commands::FolderStore::CheckLogger;

use parent -norequire, 'CDS::Commands::FolderStore::Logger';

#line 3 "Condensation/CLI/Commands/FolderStore/CheckLogger.pm"
sub finalizeWrong {
	my $o = shift;
...
#line 8 "Condensation/CLI/Commands/FolderStore/CheckLogger.pm"
sub summary {
	my $o = shift;
...
#line 1 "Condensation/CLI/Commands/FolderStore/FixLogger.pm"
package CDS::Commands::FolderStore::FixLogger;

use parent -norequire, 'CDS::Commands::FolderStore::Logger';

#line 3 "Condensation/CLI/Commands/FolderStore/FixLogger.pm"
sub finalizeWrong {
	my $o = shift;
...
#line 8 "Condensation/CLI/Commands/FolderStore/FixLogger.pm"
sub summary {
	my $o = shift;
...
#line 1 "Condensation/CLI/Commands/FolderStore/Logger.pm"
...
#line 11 "Condensation/CLI/Commands/FolderStore/Logger.pm"
sub correct {
	my $o = shift;
...
#line 15 "Condensation/CLI/Commands/FolderStore/Logger.pm"
sub wrong {
	my $o = shift;
	my $item = shift;
	my $uid = shift;
...
#line 26 "Condensation/CLI/Commands/FolderStore/Logger.pm"
sub username {
	my $uid = shift;
...
#line 30 "Condensation/CLI/Commands/FolderStore/Logger.pm"
sub groupname {
	my $gid = shift;
...
#line 34 "Condensation/CLI/Commands/FolderStore/Logger.pm"
sub accessError {
	my $o = shift;
	my $item = shift;
...
#line 39 "Condensation/CLI/Commands/FolderStore/Logger.pm"
sub setError {
	my $o = shift;
	my $item = shift;
...
#line 1 "Condensation/CLI/Commands/FolderStore/SetLogger.pm"
package CDS::Commands::FolderStore::SetLogger;

use parent -norequire, 'CDS::Commands::FolderStore::Logger';

#line 3 "Condensation/CLI/Commands/FolderStore/SetLogger.pm"
sub finalizeWrong {
	my $o = shift;
...
#line 7 "Condensation/CLI/Commands/FolderStore/SetLogger.pm"
sub summary {
	my $o = shift;
...
#line 1 "Condensation/CLI/Commands/Get.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::Get;

#line 3 "Condensation/CLI/Commands/Get.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 1 "Condensation/CLI/Commands/Help.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::Help;

#line 3 "Condensation/CLI/Commands/Help.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 19 "Condensation/CLI/Commands/Help.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 53 "Condensation/CLI/Commands/Help.pm"
sub version {
	my $o = shift;
	my $cmd = shift;
...
#line 1 "Condensation/CLI/Commands/List.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::List;

#line 3 "Condensation/CLI/Commands/List.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 58 "Condensation/CLI/Commands/List.pm"
sub collectAccount {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 63 "Condensation/CLI/Commands/List.pm"
sub collectActor {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 67 "Condensation/CLI/Commands/List.pm"
sub collectActorgroup {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 71 "Condensation/CLI/Commands/List.pm"
sub collectBox {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 75 "Condensation/CLI/Commands/List.pm"
sub collectKeypair {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 80 "Condensation/CLI/Commands/List.pm"
sub collectMessages {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 84 "Condensation/CLI/Commands/List.pm"
sub collectMy {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 88 "Condensation/CLI/Commands/List.pm"
sub collectPrivate {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 92 "Condensation/CLI/Commands/List.pm"
sub collectPublic {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 96 "Condensation/CLI/Commands/List.pm"
sub collectStore {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 100 "Condensation/CLI/Commands/List.pm"
sub collectWatch {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 104 "Condensation/CLI/Commands/List.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 137 "Condensation/CLI/Commands/List.pm"
sub listBoxes {
	my $o = shift;
	my $cmd = shift;
...
#line 152 "Condensation/CLI/Commands/List.pm"
sub list {
	my $o = shift;
	my $cmd = shift;
...
#line 192 "Condensation/CLI/Commands/List.pm"
sub listBox {
	my $o = shift;
	my $boxToken = shift;
...
#line 1 "Condensation/CLI/Commands/Modify.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::Modify;

#line 3 "Condensation/CLI/Commands/Modify.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 58 "Condensation/CLI/Commands/Modify.pm"
sub collectAccount {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 63 "Condensation/CLI/Commands/Modify.pm"
sub collectActor {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 67 "Condensation/CLI/Commands/Modify.pm"
sub collectBox {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 71 "Condensation/CLI/Commands/Modify.pm"
sub collectFile {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 75 "Condensation/CLI/Commands/Modify.pm"
sub collectHash {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 79 "Condensation/CLI/Commands/Modify.pm"
sub collectHash1 {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 83 "Condensation/CLI/Commands/Modify.pm"
sub collectKeypair {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 88 "Condensation/CLI/Commands/Modify.pm"
sub collectMessages {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 92 "Condensation/CLI/Commands/Modify.pm"
sub collectPrivate {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 96 "Condensation/CLI/Commands/Modify.pm"
sub collectPublic {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 100 "Condensation/CLI/Commands/Modify.pm"
sub collectPurge {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 104 "Condensation/CLI/Commands/Modify.pm"
sub collectStore {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 110 "Condensation/CLI/Commands/Modify.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 141 "Condensation/CLI/Commands/Modify.pm"
sub modify {
	my $o = shift;
	my $cmd = shift;
...
#line 1 "Condensation/CLI/Commands/OpenEnvelope.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::OpenEnvelope;

#line 3 "Condensation/CLI/Commands/OpenEnvelope.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 40 "Condensation/CLI/Commands/OpenEnvelope.pm"
sub collectAccount {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 45 "Condensation/CLI/Commands/OpenEnvelope.pm"
sub collectActor {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 49 "Condensation/CLI/Commands/OpenEnvelope.pm"
sub collectHash {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 54 "Condensation/CLI/Commands/OpenEnvelope.pm"
sub collectKeypair {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 58 "Condensation/CLI/Commands/OpenEnvelope.pm"
sub collectObject {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 63 "Condensation/CLI/Commands/OpenEnvelope.pm"
sub collectStore {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 67 "Condensation/CLI/Commands/OpenEnvelope.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 92 "Condensation/CLI/Commands/OpenEnvelope.pm"
sub openEnvelope {
	my $o = shift;
	my $cmd = shift;
...
#line 118 "Condensation/CLI/Commands/OpenEnvelope.pm"
sub processOther {
	my $o = shift;
	my $envelope = shift; die 'wrong type '.ref($envelope).' for $envelope' if defined $envelope && ref $envelope ne 'CDS::Record';
...
#line 127 "Condensation/CLI/Commands/OpenEnvelope.pm"
...
#line 142 "Condensation/CLI/Commands/OpenEnvelope.pm"
...
#line 164 "Condensation/CLI/Commands/OpenEnvelope.pm"
...
#line 177 "Condensation/CLI/Commands/OpenEnvelope.pm"
...
#line 1 "Condensation/CLI/Commands/Put.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::Put;

#line 3 "Condensation/CLI/Commands/Put.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 49 "Condensation/CLI/Commands/Put.pm"
sub collectAeskey {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 53 "Condensation/CLI/Commands/Put.pm"
sub collectFile {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 57 "Condensation/CLI/Commands/Put.pm"
sub collectHash {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 61 "Condensation/CLI/Commands/Put.pm"
sub collectKeypair {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 65 "Condensation/CLI/Commands/Put.pm"
sub collectObjectfile {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 69 "Condensation/CLI/Commands/Put.pm"
sub collectStore {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 73 "Condensation/CLI/Commands/Put.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 96 "Condensation/CLI/Commands/Put.pm"
sub put {
	my $o = shift;
	my $cmd = shift;
...
#line 110 "Condensation/CLI/Commands/Put.pm"
sub putObjectFile {
	my $o = shift;
...
#line 124 "Condensation/CLI/Commands/Put.pm"
...
#line 141 "Condensation/CLI/Commands/Put.pm"
sub putObject {
	my $o = shift;
	my $object = shift; die 'wrong type '.ref($object).' for $object' if defined $object && ref $object ne 'CDS::Object';
...
#line 5 "Condensation/CLI/Commands/Remember.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 34 "Condensation/CLI/Commands/Remember.pm"
sub collectAccount {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 39 "Condensation/CLI/Commands/Remember.pm"
sub collectActor {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 43 "Condensation/CLI/Commands/Remember.pm"
sub collectKeypair {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 47 "Condensation/CLI/Commands/Remember.pm"
sub collectLabel {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 51 "Condensation/CLI/Commands/Remember.pm"
sub collectStore {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 55 "Condensation/CLI/Commands/Remember.pm"
sub collectText {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 59 "Condensation/CLI/Commands/Remember.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 82 "Condensation/CLI/Commands/Remember.pm"
sub remember {
	my $o = shift;
	my $cmd = shift;
...
#line 93 "Condensation/CLI/Commands/Remember.pm"
sub forget {
	my $o = shift;
	my $cmd = shift;
...
#line 104 "Condensation/CLI/Commands/Remember.pm"
sub showLabels {
	my $o = shift;
	my $cmd = shift;
...
#line 110 "Condensation/CLI/Commands/Remember.pm"
...
#line 144 "Condensation/CLI/Commands/Remember.pm"
...
#line 1 "Condensation/CLI/Commands/Select.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::Select;

#line 3 "Condensation/CLI/Commands/Select.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 58 "Condensation/CLI/Commands/Select.pm"
sub collectAccount {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 63 "Condensation/CLI/Commands/Select.pm"
sub collectActor {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 67 "Condensation/CLI/Commands/Select.pm"
sub collectKeypair {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 72 "Condensation/CLI/Commands/Select.pm"
sub collectStore {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 76 "Condensation/CLI/Commands/Select.pm"
sub collectStore1 {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 80 "Condensation/CLI/Commands/Select.pm"
sub collectStore2 {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 84 "Condensation/CLI/Commands/Select.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 119 "Condensation/CLI/Commands/Select.pm"
sub select {
	my $o = shift;
	my $cmd = shift;
...
#line 140 "Condensation/CLI/Commands/Select.pm"
sub unselectKeyPair {
	my $o = shift;
	my $cmd = shift;
...
#line 146 "Condensation/CLI/Commands/Select.pm"
sub unselectStore {
	my $o = shift;
	my $cmd = shift;
...
#line 152 "Condensation/CLI/Commands/Select.pm"
sub unselectActor {
	my $o = shift;
	my $cmd = shift;
...
#line 158 "Condensation/CLI/Commands/Select.pm"
sub unselectAll {
	my $o = shift;
	my $cmd = shift;
...
#line 166 "Condensation/CLI/Commands/Select.pm"
...
#line 172 "Condensation/CLI/Commands/Select.pm"
sub showSelection {
	my $o = shift;
...
#line 1 "Condensation/CLI/Commands/ShowCard.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::ShowCard;

#line 3 "Condensation/CLI/Commands/ShowCard.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 41 "Condensation/CLI/Commands/ShowCard.pm"
sub collectAccount {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 45 "Condensation/CLI/Commands/ShowCard.pm"
sub collectActor {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 49 "Condensation/CLI/Commands/ShowCard.pm"
sub collectActorgroup {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 57 "Condensation/CLI/Commands/ShowCard.pm"
sub collectKeypair {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 62 "Condensation/CLI/Commands/ShowCard.pm"
sub collectStore {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 66 "Condensation/CLI/Commands/ShowCard.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 98 "Condensation/CLI/Commands/ShowCard.pm"
sub showCard {
	my $o = shift;
	my $cmd = shift;
...
#line 124 "Condensation/CLI/Commands/ShowCard.pm"
sub showMyCard {
	my $o = shift;
	my $cmd = shift;
...
#line 131 "Condensation/CLI/Commands/ShowCard.pm"
sub processAccount {
	my $o = shift;
	my $accountToken = shift;
...
#line 152 "Condensation/CLI/Commands/ShowCard.pm"
sub processEntry {
	my $o = shift;
	my $accountToken = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
...
#line 176 "Condensation/CLI/Commands/ShowCard.pm"
sub getPublicKey {
	my $o = shift;
	my $accountToken = shift;
...
#line 185 "Condensation/CLI/Commands/ShowCard.pm"
sub addKnownPublicKey {
	my $o = shift;
	my $publicKey = shift; die 'wrong type '.ref($publicKey).' for $publicKey' if defined $publicKey && ref $publicKey ne 'CDS::PublicKey';
...
#line 1 "Condensation/CLI/Commands/ShowKeyPair.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::ShowKeyPair;

#line 3 "Condensation/CLI/Commands/ShowKeyPair.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 30 "Condensation/CLI/Commands/ShowKeyPair.pm"
sub collectKeypair {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 34 "Condensation/CLI/Commands/ShowKeyPair.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 50 "Condensation/CLI/Commands/ShowKeyPair.pm"
sub showKeyPair {
	my $o = shift;
	my $cmd = shift;
...
#line 55 "Condensation/CLI/Commands/ShowKeyPair.pm"
sub showMyKeyPair {
	my $o = shift;
	my $cmd = shift;
...
#line 60 "Condensation/CLI/Commands/ShowKeyPair.pm"
...
#line 65 "Condensation/CLI/Commands/ShowKeyPair.pm"
sub show {
	my $o = shift;
	my $keyPairToken = shift;
...
#line 70 "Condensation/CLI/Commands/ShowKeyPair.pm"
sub showAll {
	my $o = shift;
	my $keyPairToken = shift;
...
#line 80 "Condensation/CLI/Commands/ShowKeyPair.pm"
...
#line 87 "Condensation/CLI/Commands/ShowKeyPair.pm"
sub showPublicKey {
	my $o = shift;
	my $keyPairToken = shift;
...
#line 95 "Condensation/CLI/Commands/ShowKeyPair.pm"
sub showPrivateKey {
	my $o = shift;
	my $keyPairToken = shift;
...
#line 104 "Condensation/CLI/Commands/ShowKeyPair.pm"
sub byteData {
	my $o = shift;
	my $label = shift;
	my $bytes = shift;
...
#line 1 "Condensation/CLI/Commands/ShowMessages.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::ShowMessages;

#line 3 "Condensation/CLI/Commands/ShowMessages.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 43 "Condensation/CLI/Commands/ShowMessages.pm"
sub collectAccount {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 47 "Condensation/CLI/Commands/ShowMessages.pm"
sub collectActor {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 51 "Condensation/CLI/Commands/ShowMessages.pm"
sub collectActor1 {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 55 "Condensation/CLI/Commands/ShowMessages.pm"
sub collectActorgroup {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 61 "Condensation/CLI/Commands/ShowMessages.pm"
sub collectKeypair {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 66 "Condensation/CLI/Commands/ShowMessages.pm"
sub collectKeypair1 {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 71 "Condensation/CLI/Commands/ShowMessages.pm"
sub collectStore {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 76 "Condensation/CLI/Commands/ShowMessages.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 111 "Condensation/CLI/Commands/ShowMessages.pm"
...
#line 116 "Condensation/CLI/Commands/ShowMessages.pm"
sub showMyMessages {
	my $o = shift;
	my $cmd = shift;
...
#line 123 "Condensation/CLI/Commands/ShowMessages.pm"
sub showOurMessages {
	my $o = shift;
	my $cmd = shift;
...
#line 141 "Condensation/CLI/Commands/ShowMessages.pm"
sub showMessages {
	my $o = shift;
	my $cmd = shift;
...
#line 151 "Condensation/CLI/Commands/ShowMessages.pm"
sub processAccounts {
	my $o = shift;
...
#line 1 "Condensation/CLI/Commands/ShowMessages/ProcessAccount.pm"
...
#line 24 "Condensation/CLI/Commands/ShowMessages/ProcessAccount.pm"
sub getPublicKey {
	my $o = shift;
...
#line 32 "Condensation/CLI/Commands/ShowMessages/ProcessAccount.pm"
sub onMessageBoxVerifyStore {
	my $o = shift;
	my $senderStoreUrl = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
...
#line 36 "Condensation/CLI/Commands/ShowMessages/ProcessAccount.pm"
sub onMessageBoxEntry {
	my $o = shift;
	my $message = shift;
...
#line 51 "Condensation/CLI/Commands/ShowMessages/ProcessAccount.pm"
sub onMessageBoxInvalidEntry {
	my $o = shift;
	my $source = shift; die 'wrong type '.ref($source).' for $source' if defined $source && ref $source ne 'CDS::Source';
	my $reason = shift;
...
#line 1 "Condensation/CLI/Commands/ShowObject.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::ShowObject;

#line 3 "Condensation/CLI/Commands/ShowObject.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 53 "Condensation/CLI/Commands/ShowObject.pm"
sub collectAeskey {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 57 "Condensation/CLI/Commands/ShowObject.pm"
sub collectBytes {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 61 "Condensation/CLI/Commands/ShowObject.pm"
sub collectData {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 65 "Condensation/CLI/Commands/ShowObject.pm"
sub collectFile {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 69 "Condensation/CLI/Commands/ShowObject.pm"
sub collectHash {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 73 "Condensation/CLI/Commands/ShowObject.pm"
sub collectHash1 {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 77 "Condensation/CLI/Commands/ShowObject.pm"
sub collectHash2 {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 82 "Condensation/CLI/Commands/ShowObject.pm"
sub collectHashes {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 86 "Condensation/CLI/Commands/ShowObject.pm"
sub collectObject {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 91 "Condensation/CLI/Commands/ShowObject.pm"
sub collectObject1 {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 96 "Condensation/CLI/Commands/ShowObject.pm"
sub collectRecord {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 100 "Condensation/CLI/Commands/ShowObject.pm"
sub collectSize {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 104 "Condensation/CLI/Commands/ShowObject.pm"
sub collectStore {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 108 "Condensation/CLI/Commands/ShowObject.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 152 "Condensation/CLI/Commands/ShowObject.pm"
sub show {
	my $o = shift;
	my $cmd = shift;
...
#line 170 "Condensation/CLI/Commands/ShowObject.pm"
...
#line 175 "Condensation/CLI/Commands/ShowObject.pm"
...
#line 179 "Condensation/CLI/Commands/ShowObject.pm"
sub loadCommand {
	my $o = shift;
...
#line 185 "Condensation/CLI/Commands/ShowObject.pm"
sub showHash {
	my $o = shift;
...
#line 191 "Condensation/CLI/Commands/ShowObject.pm"
sub showSize {
	my $o = shift;
...
#line 199 "Condensation/CLI/Commands/ShowObject.pm"
sub showBytes {
	my $o = shift;
...
#line 212 "Condensation/CLI/Commands/ShowObject.pm"
sub showHashes {
	my $o = shift;
...
#line 223 "Condensation/CLI/Commands/ShowObject.pm"
sub showData {
	my $o = shift;
...
#line 235 "Condensation/CLI/Commands/ShowObject.pm"
sub showRecord {
	my $o = shift;
...
#line 1 "Condensation/CLI/Commands/ShowPrivateData.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::ShowPrivateData;

#line 3 "Condensation/CLI/Commands/ShowPrivateData.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 50 "Condensation/CLI/Commands/ShowPrivateData.pm"
sub collectDate {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 54 "Condensation/CLI/Commands/ShowPrivateData.pm"
sub collectHash {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 58 "Condensation/CLI/Commands/ShowPrivateData.pm"
sub collectId {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 62 "Condensation/CLI/Commands/ShowPrivateData.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 87 "Condensation/CLI/Commands/ShowPrivateData.pm"
sub showGroupData {
	my $o = shift;
	my $cmd = shift;
...
#line 93 "Condensation/CLI/Commands/ShowPrivateData.pm"
sub showLocalData {
	my $o = shift;
	my $cmd = shift;
...
#line 99 "Condensation/CLI/Commands/ShowPrivateData.pm"
sub showSentList {
	my $o = shift;
	my $cmd = shift;
...
#line 1 "Condensation/CLI/Commands/ShowTree.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::ShowTree;

#line 3 "Condensation/CLI/Commands/ShowTree.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 34 "Condensation/CLI/Commands/ShowTree.pm"
sub collectHash {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 38 "Condensation/CLI/Commands/ShowTree.pm"
sub collectObject {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 42 "Condensation/CLI/Commands/ShowTree.pm"
sub collectStore {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 46 "Condensation/CLI/Commands/ShowTree.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 64 "Condensation/CLI/Commands/ShowTree.pm"
sub showTree {
	my $o = shift;
	my $cmd = shift;
...
#line 94 "Condensation/CLI/Commands/ShowTree.pm"
sub process {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $store = shift;
...
#line 1 "Condensation/CLI/Commands/StartHTTPServer.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::StartHTTPServer;

#line 3 "Condensation/CLI/Commands/StartHTTPServer.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 47 "Condensation/CLI/Commands/StartHTTPServer.pm"
sub collectEverybody {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 51 "Condensation/CLI/Commands/StartHTTPServer.pm"
sub collectFolder {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 55 "Condensation/CLI/Commands/StartHTTPServer.pm"
sub collectPort {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 59 "Condensation/CLI/Commands/StartHTTPServer.pm"
sub collectStore {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 63 "Condensation/CLI/Commands/StartHTTPServer.pm"
sub collectText {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 67 "Condensation/CLI/Commands/StartHTTPServer.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 96 "Condensation/CLI/Commands/StartHTTPServer.pm"
sub startHttpServer {
	my $o = shift;
	my $cmd = shift;
...
#line 1 "Condensation/CLI/Commands/StartHTTPServer/Logger.pm"
...
#line 5 "Condensation/CLI/Commands/StartHTTPServer/Logger.pm"
sub onServerStarts {
	my $o = shift;
	my $port = shift;
...
#line 11 "Condensation/CLI/Commands/StartHTTPServer/Logger.pm"
sub onRequestStarts {
	my $o = shift;
	my $request = shift;
	 }

#line 13 "Condensation/CLI/Commands/StartHTTPServer/Logger.pm"
sub onRequestError {
	my $o = shift;
	my $request = shift;
...
#line 18 "Condensation/CLI/Commands/StartHTTPServer/Logger.pm"
sub onRequestDone {
	my $o = shift;
	my $request = shift;
...
#line 1 "Condensation/CLI/Commands/Transfer.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::Transfer;

#line 3 "Condensation/CLI/Commands/Transfer.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 1 "Condensation/CLI/Commands/UseCache.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::UseCache;

#line 3 "Condensation/CLI/Commands/UseCache.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 20 "Condensation/CLI/Commands/UseCache.pm"
sub collectStore {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 24 "Condensation/CLI/Commands/UseCache.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 45 "Condensation/CLI/Commands/UseCache.pm"
sub useCache {
	my $o = shift;
	my $cmd = shift;
...
#line 53 "Condensation/CLI/Commands/UseCache.pm"
sub dropCache {
	my $o = shift;
	my $cmd = shift;
...
#line 59 "Condensation/CLI/Commands/UseCache.pm"
sub cache {
	my $o = shift;
	my $cmd = shift;
...
#line 1 "Condensation/CLI/Commands/UseStore.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::UseStore;

#line 3 "Condensation/CLI/Commands/UseStore.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 18 "Condensation/CLI/Commands/UseStore.pm"
sub collectStore {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 22 "Condensation/CLI/Commands/UseStore.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 36 "Condensation/CLI/Commands/UseStore.pm"
...
#line 1 "Condensation/CLI/Commands/Welcome.pm"
# BEGIN AUTOGENERATED
package CDS::Commands::Welcome;

#line 3 "Condensation/CLI/Commands/Welcome.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 26 "Condensation/CLI/Commands/Welcome.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 46 "Condensation/CLI/Commands/Welcome.pm"
sub suppress {
	my $o = shift;
	my $cmd = shift;
...
#line 60 "Condensation/CLI/Commands/Welcome.pm"
sub enable {
	my $o = shift;
	my $cmd = shift;
...
#line 69 "Condensation/CLI/Commands/Welcome.pm"
sub isEnabled {
	my $o = shift;
	 ! $o->{actor}->localRoot->child('suppress welcome message')->isSet }

#line 71 "Condensation/CLI/Commands/Welcome.pm"
sub show {
	my $o = shift;
	my $cmd = shift;
...
#line 5 "Condensation/CLI/Commands/WhatIs.pm"
sub register {
	my $class = shift;
	my $cds = shift;
	my $help = shift;
...
#line 18 "Condensation/CLI/Commands/WhatIs.pm"
sub collectText {
	my $o = shift;
	my $label = shift;
	my $value = shift;
...
#line 22 "Condensation/CLI/Commands/WhatIs.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	 bless {actor => $actor, ui => $actor->ui} }
...
#line 36 "Condensation/CLI/Commands/WhatIs.pm"
sub whatIs {
	my $o = shift;
	my $cmd = shift;
...
#line 70 "Condensation/CLI/Commands/WhatIs.pm"
sub test {
	my $o = shift;
	my $expect = shift;
	my $text = shift;
...
#line 81 "Condensation/CLI/Commands/WhatIs.pm"
sub keyPairResult {
	my $keyPairToken = shift;
...
#line 85 "Condensation/CLI/Commands/WhatIs.pm"
...
#line 90 "Condensation/CLI/Commands/WhatIs.pm"
sub fileResult {
	my $file = shift;
...
#line 1 "Condensation/CLI/Configuration.pm"
...
#line 4 "Condensation/CLI/Configuration.pm"
...
#line 10 "Condensation/CLI/Configuration.pm"
sub new {
	my $class = shift;
	my $ui = shift;
	my $folder = shift;
...
#line 17 "Condensation/CLI/Configuration.pm"
...
#line 33 "Condensation/CLI/Configuration.pm"
sub createFolder {
	my $o = shift;
	my $folder = shift;
...
#line 41 "Condensation/CLI/Configuration.pm"
sub file {
	my $o = shift;
	my $filename = shift;
...
#line 45 "Condensation/CLI/Configuration.pm"
...
#line 49 "Condensation/CLI/Configuration.pm"
sub storageStoreUrl {
	my $o = shift;
...
#line 53 "Condensation/CLI/Configuration.pm"
...
#line 57 "Condensation/CLI/Configuration.pm"
...
#line 61 "Condensation/CLI/Configuration.pm"
sub keyPair {
	my $o = shift;
...
#line 65 "Condensation/CLI/Configuration.pm"
sub setKeyPair {
	my $o = shift;
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 69 "Condensation/CLI/Configuration.pm"
sub readFirstLine {
	my $o = shift;
	my $file = shift;
...
#line 5 "Condensation/Actors/DiscoverActorGroup.pm"
sub discover {
	my $class = shift;
...
#line 90 "Condensation/Actors/DiscoverActorGroup.pm"
sub node {
	my $o = shift;
	my $actorHash = shift; die 'wrong type '.ref($actorHash).' for $actorHash' if defined $actorHash && ref $actorHash ne 'CDS::Hash';
	my $storeUrl = shift;
...
#line 97 "Condensation/Actors/DiscoverActorGroup.pm"
sub covers {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	 $o->{coverage}->{$hash->bytes} }

#line 99 "Condensation/Actors/DiscoverActorGroup.pm"
sub extend {
	my $o = shift;
...
#line 1 "Condensation/Actors/DiscoverActorGroup/Card.pm"
...
#line 1 "Condensation/Actors/DiscoverActorGroup/Link.pm"
...
#line 1 "Condensation/Actors/DiscoverActorGroup/Node.pm"
...
#line 18 "Condensation/Actors/DiscoverActorGroup/Node.pm"
sub cards {
	my $o = shift;
	 @{$o->{cards}} }
sub isActive {
...
#line 29 "Condensation/Actors/DiscoverActorGroup/Node.pm"
sub discover {
	my $o = shift;
...
#line 35 "Condensation/Actors/DiscoverActorGroup/Node.pm"
sub readCards {
	my $o = shift;
...
#line 114 "Condensation/Actors/DiscoverActorGroup/Node.pm"
sub attach {
	my $o = shift;
...
#line 130 "Condensation/Actors/DiscoverActorGroup/Node.pm"
sub merge {
	my $o = shift;
	my $revision = shift;
	my $status = shift;
...
#line 136 "Condensation/Actors/DiscoverActorGroup/Node.pm"
sub hasLinkToUs {
	my $o = shift;
...
#line 3 "Condensation/Stores/ErrorHandlingStore.pm"
sub new {
	my $class = shift;
	my $store = shift;
	my $url = shift;
...
#line 15 "Condensation/Stores/ErrorHandlingStore.pm"
sub id {
	my $o = shift;
	 'Error handling'."\n  ".$o->{store}->id }

#line 17 "Condensation/Stores/ErrorHandlingStore.pm"
sub get {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 30 "Condensation/Stores/ErrorHandlingStore.pm"
sub book {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 43 "Condensation/Stores/ErrorHandlingStore.pm"
sub put {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $object = shift; die 'wrong type '.ref($object).' for $object' if defined $object && ref $object ne 'CDS::Object';
...
#line 56 "Condensation/Stores/ErrorHandlingStore.pm"
sub list {
	my $o = shift;
	my $accountHash = shift; die 'wrong type '.ref($accountHash).' for $accountHash' if defined $accountHash && ref $accountHash ne 'CDS::Hash';
	my $boxLabel = shift;
...
#line 69 "Condensation/Stores/ErrorHandlingStore.pm"
sub add {
	my $o = shift;
	my $accountHash = shift; die 'wrong type '.ref($accountHash).' for $accountHash' if defined $accountHash && ref $accountHash ne 'CDS::Hash';
	my $boxLabel = shift;
...
#line 82 "Condensation/Stores/ErrorHandlingStore.pm"
sub remove {
	my $o = shift;
	my $accountHash = shift; die 'wrong type '.ref($accountHash).' for $accountHash' if defined $accountHash && ref $accountHash ne 'CDS::Hash';
	my $boxLabel = shift;
...
#line 95 "Condensation/Stores/ErrorHandlingStore.pm"
sub modify {
	my $o = shift;
	my $modifications = shift;
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 1 "Condensation/Stores/FolderStore.pm"
# A Condensation store on a local folder.
package CDS::FolderStore;

use parent -norequire, 'CDS::Store';

#line 7 "Condensation/Stores/FolderStore.pm"
sub forUrl {
	my $class = shift;
	my $url = shift;
...
#line 12 "Condensation/Stores/FolderStore.pm"
sub new {
	my $class = shift;
	my $folder = shift;
...
#line 19 "Condensation/Stores/FolderStore.pm"
sub id {
	my $o = shift;
	 'file://'.$o->{folder} }
sub folder { shift->{folder} }
...
#line 25 "Condensation/Stores/FolderStore.pm"
sub get {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 31 "Condensation/Stores/FolderStore.pm"
sub book {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 40 "Condensation/Stores/FolderStore.pm"
sub put {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $object = shift; die 'wrong type '.ref($object).' for $object' if defined $object && ref $object ne 'CDS::Object';
...
#line 55 "Condensation/Stores/FolderStore.pm"
sub list {
	my $o = shift;
	my $accountHash = shift; die 'wrong type '.ref($accountHash).' for $accountHash' if defined $accountHash && ref $accountHash ne 'CDS::Hash';
	my $boxLabel = shift;
...
#line 81 "Condensation/Stores/FolderStore.pm"
sub listFolder {
	my $o = shift;
	my $boxFolder = shift;
		# private
...
#line 90 "Condensation/Stores/FolderStore.pm"
sub add {
	my $o = shift;
	my $accountHash = shift; die 'wrong type '.ref($accountHash).' for $accountHash' if defined $accountHash && ref $accountHash ne 'CDS::Hash';
	my $boxLabel = shift;
...
#line 105 "Condensation/Stores/FolderStore.pm"
sub remove {
	my $o = shift;
	my $accountHash = shift; die 'wrong type '.ref($accountHash).' for $accountHash' if defined $accountHash && ref $accountHash ne 'CDS::Hash';
	my $boxLabel = shift;
...
#line 114 "Condensation/Stores/FolderStore.pm"
sub modify {
	my $o = shift;
	my $modifications = shift;
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 120 "Condensation/Stores/FolderStore.pm"
sub exists {
	my $o = shift;
...
#line 1 "Condensation/Stores/FolderStore/PosixPermissions.pm"
...
#line 21 "Condensation/Stores/FolderStore/PosixPermissions.pm"
sub user {
	my $o = shift;
...
#line 26 "Condensation/Stores/FolderStore/PosixPermissions.pm"
sub group {
	my $o = shift;
...
#line 31 "Condensation/Stores/FolderStore/PosixPermissions.pm"
...
#line 46 "Condensation/Stores/FolderStore/PosixPermissions.pm"
sub mkdir {
	my $o = shift;
	my $folder = shift;
	my $mode = shift;
...
#line 1 "Condensation/Stores/FolderStore/PosixPermissions/Group.pm"
...
#line 5 "Condensation/Stores/FolderStore/PosixPermissions/Group.pm"
sub new {
	my $class = shift;
	my $gid = shift;
...
#line 9 "Condensation/Stores/FolderStore/PosixPermissions/Group.pm"
sub target {
	my $o = shift;
...
#line 1 "Condensation/Stores/FolderStore/PosixPermissions/User.pm"
...
#line 4 "Condensation/Stores/FolderStore/PosixPermissions/User.pm"
sub new {
	my $class = shift;
	my $uid = shift;
...
#line 8 "Condensation/Stores/FolderStore/PosixPermissions/User.pm"
sub target {
	my $o = shift;
	 'user '.$o->user }
...
#line 1 "Condensation/Stores/FolderStore/PosixPermissions/World.pm"
...
#line 5 "Condensation/Stores/FolderStore/PosixPermissions/World.pm"
sub new {
	my $class = shift;
...
#line 1 "Condensation/HTTPServer/HTTPServer/IdentificationHandler.pm"
...
#line 5 "Condensation/HTTPServer/HTTPServer/IdentificationHandler.pm"
sub process {
	my $o = shift;
	my $request = shift;
...
#line 1 "Condensation/HTTPServer/HTTPServer/Logger.pm"
...
#line 8 "Condensation/HTTPServer/HTTPServer/Logger.pm"
sub onServerStarts {
	my $o = shift;
	my $port = shift;
...
#line 15 "Condensation/HTTPServer/HTTPServer/Logger.pm"
sub onRequestStarts {
	my $o = shift;
	my $request = shift;
...
#line 23 "Condensation/HTTPServer/HTTPServer/Logger.pm"
sub onRequestError {
	my $o = shift;
	my $request = shift;
...
#line 30 "Condensation/HTTPServer/HTTPServer/Logger.pm"
sub onRequestDone {
	my $o = shift;
	my $request = shift;
	my $responseCode = shift;
...
#line 1 "Condensation/HTTPServer/HTTPServer/MessageGatewayHandler.pm"
...
#line 9 "Condensation/HTTPServer/HTTPServer/StaticContentHandler.pm"
sub process {
	my $o = shift;
	my $request = shift;
...
#line 1 "Condensation/HTTPServer/HTTPServer/StaticFilesHandler.pm"
...
#line 29 "Condensation/HTTPServer/HTTPServer/StaticFilesHandler.pm"
sub setContentType {
	my $o = shift;
	my $extension = shift;
	my $contentType = shift;
...
#line 33 "Condensation/HTTPServer/HTTPServer/StaticFilesHandler.pm"
sub process {
	my $o = shift;
	my $request = shift;
...
#line 44 "Condensation/HTTPServer/HTTPServer/StaticFilesHandler.pm"
sub get {
	my $o = shift;
	my $request = shift;
...
#line 49 "Condensation/HTTPServer/HTTPServer/StaticFilesHandler.pm"
...
#line 66 "Condensation/HTTPServer/HTTPServer/StaticFilesHandler.pm"
sub deliverFile {
	my $o = shift;
	my $request = shift;
	my $file = shift;
...
#line 1 "Condensation/HTTPServer/HTTPServer/StoreHandler.pm"
...
#line 12 "Condensation/HTTPServer/HTTPServer/StoreHandler.pm"
sub process {
	my $o = shift;
	my $request = shift;
...
#line 56 "Condensation/HTTPServer/HTTPServer/StoreHandler.pm"
sub objects {
	my $o = shift;
	my $request = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
...
#line 100 "Condensation/HTTPServer/HTTPServer/StoreHandler.pm"
sub box {
	my $o = shift;
	my $request = shift;
	my $accountHash = shift; die 'wrong type '.ref($accountHash).' for $accountHash' if defined $accountHash && ref $accountHash ne 'CDS::Hash';
...
#line 1 "Condensation/Stores/HTTPStore.pm"
# A Condensation store accessed through HTTP or HTTPS.
package CDS::HTTPStore;

use parent -norequire, 'CDS::Store';

#line 9 "Condensation/Stores/HTTPStore.pm"
sub forUrl {
	my $class = shift;
	my $url = shift;
...
#line 14 "Condensation/Stores/HTTPStore.pm"
sub new {
	my $class = shift;
	my $url = shift;
...
#line 18 "Condensation/Stores/HTTPStore.pm"
sub id {
	my $o = shift;
	 $o->{url} }

#line 20 "Condensation/Stores/HTTPStore.pm"
sub get {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 27 "Condensation/Stores/HTTPStore.pm"
sub put {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $object = shift; die 'wrong type '.ref($object).' for $object' if defined $object && ref $object ne 'CDS::Object';
...
#line 35 "Condensation/Stores/HTTPStore.pm"
sub book {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 42 "Condensation/Stores/HTTPStore.pm"
sub list {
	my $o = shift;
	my $accountHash = shift; die 'wrong type '.ref($accountHash).' for $accountHash' if defined $accountHash && ref $accountHash ne 'CDS::Hash';
	my $boxLabel = shift;
...
#line 1 "Condensation/Serialization/Hash.pm"
# Models a hash, and offers binary and hexadecimal representation.
package CDS::Hash;

#line 4 "Condensation/Serialization/Hash.pm"
sub fromBytes {
	my $class = shift;
...
#line 9 "Condensation/Serialization/Hash.pm"
sub fromHex {
	my $class = shift;
...
#line 15 "Condensation/Serialization/Hash.pm"
sub calculateFor {
	my $class = shift;
	my $bytes = shift;
...
#line 21 "Condensation/Serialization/Hash.pm"
sub hex {
	my $o = shift;
...
#line 25 "Condensation/Serialization/Hash.pm"
sub shortHex {
	my $o = shift;
...
#line 29 "Condensation/Serialization/Hash.pm"
sub bytes {
	my $o = shift;
	 $$o }

#line 31 "Condensation/Serialization/Hash.pm"
sub equals {
	my $this = shift;
	my $that = shift;
...
#line 37 "Condensation/Serialization/Hash.pm"
sub cmp {
	my $this = shift;
	my $that = shift;
	 $$this cmp $$that }

#line 1 "Condensation/Serialization/HashAndKey.pm"
# A hash with an AES key.
package CDS::HashAndKey;

#line 3 "Condensation/Serialization/HashAndKey.pm"
sub new {
	my $class = shift;
...
#line 1 "Condensation/Stores/InMemoryStore.pm"
...
#line 5 "Condensation/Stores/InMemoryStore.pm"
sub new {
	my $o = shift;
	my $id = shift;
...
#line 15 "Condensation/Stores/InMemoryStore.pm"
...
#line 23 "Condensation/Stores/InMemoryStore.pm"
sub get {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 28 "Condensation/Stores/InMemoryStore.pm"
sub book {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 34 "Condensation/Stores/InMemoryStore.pm"
sub put {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $object = shift; die 'wrong type '.ref($object).' for $object' if defined $object && ref $object ne 'CDS::Object';
...
#line 39 "Condensation/Stores/InMemoryStore.pm"
sub list {
	my $o = shift;
	my $accountHash = shift; die 'wrong type '.ref($accountHash).' for $accountHash' if defined $accountHash && ref $accountHash ne 'CDS::Hash';
	my $boxLabel = shift;
...
#line 45 "Condensation/Stores/InMemoryStore.pm"
sub add {
	my $o = shift;
	my $accountHash = shift; die 'wrong type '.ref($accountHash).' for $accountHash' if defined $accountHash && ref $accountHash ne 'CDS::Hash';
	my $boxLabel = shift;
...
#line 50 "Condensation/Stores/InMemoryStore.pm"
sub remove {
	my $o = shift;
	my $accountHash = shift; die 'wrong type '.ref($accountHash).' for $accountHash' if defined $accountHash && ref $accountHash ne 'CDS::Hash';
	my $boxLabel = shift;
...
#line 55 "Condensation/Stores/InMemoryStore.pm"
sub modify {
	my $o = shift;
	my $modifications = shift;
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 61 "Condensation/Stores/InMemoryStore.pm"
sub collectGarbage {
	my $o = shift;
	my $graceTime = shift;
...
#line 94 "Condensation/Stores/InMemoryStore.pm"
sub markHash {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
			# private
...
#line 99 "Condensation/Stores/InMemoryStore.pm"
sub markEntry {
	my $o = shift;
	my $entry = shift;
			# private
...
#line 3 "Condensation/Stores/Transfer.pm"
sub transfer {
	my $o = shift;
	my $hashes = shift;
...
#line 13 "Condensation/Stores/Transfer.pm"
...
#line 3 "Condensation/Actors/CreateEnvelope.pm"
...
#line 10 "Condensation/Actors/CreateEnvelope.pm"
...
#line 18 "Condensation/Actors/CreateEnvelope.pm"
...
#line 38 "Condensation/Actors/CreateEnvelope.pm"
...
#line 1 "Condensation/Actors/KeyPair.pm"
sub generate {
	my $class = shift;
...
#line 16 "Condensation/Actors/KeyPair.pm"
sub fromFile {
	my $class = shift;
	my $file = shift;
...
#line 22 "Condensation/Actors/KeyPair.pm"
sub fromHex {
	my $class = shift;
	my $hex = shift;
...
#line 26 "Condensation/Actors/KeyPair.pm"
sub fromRecord {
	my $class = shift;
...
#line 35 "Condensation/Actors/KeyPair.pm"
sub new {
	my $class = shift;
	my $publicKey = shift; die 'wrong type '.ref($publicKey).' for $publicKey' if defined $publicKey && ref $publicKey ne 'CDS::PublicKey';
...
#line 47 "Condensation/Actors/KeyPair.pm"
sub toRecord {
	my $o = shift;
...
#line 57 "Condensation/Actors/KeyPair.pm"
sub toHex {
	my $o = shift;
...
#line 62 "Condensation/Actors/KeyPair.pm"
sub writeToFile {
	my $o = shift;
	my $file = shift;
...
#line 69 "Condensation/Actors/KeyPair.pm"
sub decrypt {
	my $o = shift;
	my $bytes = shift;
		# decrypt(bytes) -> bytes
...
#line 73 "Condensation/Actors/KeyPair.pm"
sub sign {
	my $o = shift;
	my $digest = shift;
		# sign(bytes) -> bytes
...
#line 77 "Condensation/Actors/KeyPair.pm"
sub signHash {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
		# signHash(hash) -> bytes
...
#line 120 "Condensation/Actors/KeyPair.pm"
sub equals {
	my $this = shift;
	my $that = shift;
...
#line 19 "Condensation/Actors/OpenEnvelope.pm"
...
#line 1 "Condensation/CLI/KeyPairToken.pm"
# The result of parsing a KEYPAIR token (see Token.pm).
package CDS::KeyPairToken;

#line 3 "Condensation/CLI/KeyPairToken.pm"
sub new {
	my $class = shift;
	my $file = shift;
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 1 "Condensation/Actors/LoadActorGroup.pm"
...
#line 37 "Condensation/Actors/LoadActorGroup.pm"
sub getPublicKey {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
...
#line 18 "Condensation/Stores/LogStore.pm"
sub get {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 26 "Condensation/Stores/LogStore.pm"
sub put {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $object = shift; die 'wrong type '.ref($object).' for $object' if defined $object && ref $object ne 'CDS::Object';
...
#line 34 "Condensation/Stores/LogStore.pm"
sub book {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 42 "Condensation/Stores/LogStore.pm"
sub list {
	my $o = shift;
	my $accountHash = shift; die 'wrong type '.ref($accountHash).' for $accountHash' if defined $accountHash && ref $accountHash ne 'CDS::Hash';
	my $boxLabel = shift;
...
#line 50 "Condensation/Stores/LogStore.pm"
sub add {
	my $o = shift;
	my $accountHash = shift; die 'wrong type '.ref($accountHash).' for $accountHash' if defined $accountHash && ref $accountHash ne 'CDS::Hash';
	my $boxLabel = shift;
...
#line 58 "Condensation/Stores/LogStore.pm"
sub remove {
	my $o = shift;
	my $accountHash = shift; die 'wrong type '.ref($accountHash).' for $accountHash' if defined $accountHash && ref $accountHash ne 'CDS::Hash';
	my $boxLabel = shift;
...
#line 66 "Condensation/Stores/LogStore.pm"
sub modify {
	my $o = shift;
	my $modifications = shift;
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 74 "Condensation/Stores/LogStore.pm"
sub log {
	my $o = shift;
	my $cmd = shift;
	my $input = shift;
...
#line 79 "Condensation/Stores/LogStore.pm"
sub left {
	my $width = shift;
	my $text = shift;
		# private
...
#line 84 "Condensation/Stores/LogStore.pm"
...
#line 91 "Condensation/Stores/LogStore.pm"
sub formatDuration {
	my $elapsed = shift;
		# private
	my $s = ''.$elapsed;
...
#line 1 "Condensation/Actors/MessageBoxReader.pm"
# Reads the message box of an actor.
package CDS::MessageBoxReader;

#line 4 "Condensation/Actors/MessageBoxReader.pm"
sub new {
	my $class = shift;
	my $pool = shift;
	my $actorOnStore = shift; die 'wrong type '.ref($actorOnStore).' for $actorOnStore' if defined $actorOnStore && ref $actorOnStore ne 'CDS::ActorOnStore';
...
#line 16 "Condensation/Actors/MessageBoxReader.pm"
sub read {
	my $o = shift;
	my $timeout = shift // 0;
...
#line 64 "Condensation/Actors/MessageBoxReader.pm"
...
#line 110 "Condensation/Actors/MessageBoxReader.pm"
...
#line 149 "Condensation/Actors/MessageBoxReader.pm"
sub invalid {
	my $o = shift;
	my $entry = shift;
	my $reason = shift;
...
#line 154 "Condensation/Actors/MessageBoxReader.pm"
sub getPublicKey {
	my $o = shift;
	my $senderHash = shift; die 'wrong type '.ref($senderHash).' for $senderHash' if defined $senderHash && ref $senderHash ne 'CDS::Hash';
	my $senderStore = shift;
...
#line 1 "Condensation/Actors/MessageBoxReader/Entry.pm"
...
#line 1 "Condensation/Actors/MessageBoxReaderPool.pm"
...
#line 1 "Condensation/Stores/MissingObject.pm"
...
#line 1 "Condensation/Messaging/NewAnnounce.pm"
...
#line 18 "Condensation/Messaging/NewAnnounce.pm"
sub addObject {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $object = shift; die 'wrong type '.ref($object).' for $object' if defined $object && ref $object ne 'CDS::Object';
...
#line 22 "Condensation/Messaging/NewAnnounce.pm"
sub addTransfer {
	my $o = shift;
	my $hashes = shift;
	my $sourceStore = shift;
...
#line 27 "Condensation/Messaging/NewAnnounce.pm"
sub addActorGroup {
	my $o = shift;
...
#line 31 "Condensation/Messaging/NewAnnounce.pm"
sub submit {
	my $o = shift;
...
#line 1 "Condensation/Messaging/NewMessagingStore.pm"
...
#line 1 "Condensation/Serialization/Object.pm"
...
#line 6 "Condensation/Serialization/Object.pm"
sub create {
	my $class = shift;
	my $header = shift;
	my $data = shift;
...
#line 18 "Condensation/Serialization/Object.pm"
sub fromBytes {
	my $class = shift;
...
#line 33 "Condensation/Serialization/Object.pm"
sub fromFile {
	my $class = shift;
	my $file = shift;
...
#line 43 "Condensation/Serialization/Object.pm"
sub calculateHash {
	my $o = shift;
...
#line 47 "Condensation/Serialization/Object.pm"
sub hashes {
	my $o = shift;
...
#line 51 "Condensation/Serialization/Object.pm"
sub hashAtIndex {
	my $o = shift;
...
#line 56 "Condensation/Serialization/Object.pm"
sub crypt {
	my $o = shift;
	my $key = shift;
...
#line 60 "Condensation/Serialization/Object.pm"
sub writeToFile {
	my $o = shift;
	my $file = shift;
...
#line 16 "Condensation/Stores/ObjectCache.pm"
sub get {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 26 "Condensation/Stores/ObjectCache.pm"
sub put {
	my $o = shift;
...
#line 32 "Condensation/Stores/ObjectCache.pm"
sub book {
	my $o = shift;
...
#line 38 "Condensation/Stores/ObjectCache.pm"
sub list {
	my $o = shift;
...
#line 43 "Condensation/Stores/ObjectCache.pm"
sub add {
	my $o = shift;
...
#line 48 "Condensation/Stores/ObjectCache.pm"
sub remove {
	my $o = shift;
...
#line 53 "Condensation/Stores/ObjectCache.pm"
sub modify {
	my $o = shift;
...
#line 1 "Condensation/CLI/ObjectFileToken.pm"
# The result of parsing an OBJECTFILE token (see Token.pm).
package CDS::ObjectFileToken;

#line 3 "Condensation/CLI/ObjectFileToken.pm"
sub new {
	my $class = shift;
	my $file = shift;
	my $object = shift; die 'wrong type '.ref($object).' for $object' if defined $object && ref $object ne 'CDS::Object';
...
#line 1 "Condensation/CLI/ObjectToken.pm"
# The result of parsing an OBJECT token.
package CDS::ObjectToken;

#line 3 "Condensation/CLI/ObjectToken.pm"
sub new {
	my $class = shift;
	my $cliStore = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
...
#line 7 "Condensation/CLI/Parser.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	my $command = shift;
...
#line 21 "Condensation/CLI/Parser.pm"
sub execute {
	my $o = shift;
...
#line 49 "Condensation/CLI/Parser.pm"
sub advance {
	my $o = shift;
	my $token = shift;
...
#line 57 "Condensation/CLI/Parser.pm"
sub showCompletions {
	my $o = shift;
	my $cmd = shift;
...
#line 131 "Condensation/CLI/Parser.pm"
sub ambiguous {
	my $o = shift;
...
#line 137 "Condensation/CLI/Parser.pm"
sub explain {
	my $o = shift;
...
#line 147 "Condensation/CLI/Parser.pm"
sub showTuples {
	my $o = shift;
...
#line 163 "Condensation/CLI/Parser.pm"
sub cmd {
	my $o = shift;
	my $processed = shift;
...
#line 169 "Condensation/CLI/Parser.pm"
sub howToContinue {
	my $o = shift;
	my $processed = shift;
...
#line 179 "Condensation/CLI/Parser.pm"
sub invalid {
	my $o = shift;
	my $processed = shift;
	my $invalid = shift;
...
#line 199 "Condensation/CLI/Parser.pm"
sub displayWarnings {
	my $o = shift;
	my $states = shift;
...
#line 1 "Condensation/CLI/Parser/Arrow.pm"
...
#line 3 "Condensation/CLI/Parser/Arrow.pm"
sub new {
	my $class = shift;
	my $node = shift;
	my $official = shift;
...
#line 1 "Condensation/CLI/Parser/Continuations.pm"
...
#line 16 "Condensation/CLI/Parser/Continuations.pm"
sub visit {
	my $o = shift;
...
#line 38 "Condensation/CLI/Parser/Continuations.pm"
sub canContinue {
	my $o = shift;
	my $node = shift;
...
#line 24 "Condensation/CLI/Parser/Node.pm"
sub collectArrows {
	my $o = shift;
	my $arrows = shift;
...
#line 29 "Condensation/CLI/Parser/Node.pm"
sub hasHandler {
	my $o = shift;
...
#line 35 "Condensation/CLI/Parser/Node.pm"
sub getHandler {
	my $o = shift;
...
#line 1 "Condensation/CLI/Parser/State.pm"
...
#line 5 "Condensation/CLI/Parser/State.pm"
sub new {
	my $class = shift;
	my $node = shift;
	my $previous = shift;
...
#line 25 "Condensation/CLI/Parser/State.pm"
sub advance {
	my $o = shift;
	my $token = shift;
...
#line 44 "Condensation/CLI/Parser/State.pm"
sub complete {
	my $o = shift;
	my $token = shift;
...
#line 63 "Condensation/CLI/Parser/State.pm"
sub arrows {
	my $o = shift;
...
#line 69 "Condensation/CLI/Parser/State.pm"
sub path {
	my $o = shift;
...
#line 79 "Condensation/CLI/Parser/State.pm"
sub collect {
	my $o = shift;
	my $data = shift;
...
#line 4 "Condensation/CLI/Parser/Token.pm"
sub new {
	my $class = shift;
	my $actor = shift;
	my $text = shift;
...
#line 15 "Condensation/CLI/Parser/Token.pm"
sub prepare {
	my $o = shift;
	my $expect = shift;
...
#line 19 "Condensation/CLI/Parser/Token.pm"
sub as {
	my $o = shift;
	my $expect = shift;
	 exists $o->{cache}->{$expect} ? $o->{cache}->{$expect} : $o->{cache}->{$expect} = $o->produce($expect) }

#line 21 "Condensation/CLI/Parser/Token.pm"
sub produce {
	my $o = shift;
	my $expect = shift;
...
#line 45 "Condensation/CLI/Parser/Token.pm"
sub complete {
	my $o = shift;
	my $expect = shift;
...
#line 68 "Condensation/CLI/Parser/Token.pm"
sub addPossibility {
	my $o = shift;
...
#line 72 "Condensation/CLI/Parser/Token.pm"
...
#line 76 "Condensation/CLI/Parser/Token.pm"
sub isKeyword {
	my $o = shift;
	 exists $o->{keywords}->{$o->{text}} }

#line 78 "Condensation/CLI/Parser/Token.pm"
sub account {
	my $o = shift;
...
#line 102 "Condensation/CLI/Parser/Token.pm"
sub completeAccount {
	my $o = shift;
...
#line 119 "Condensation/CLI/Parser/Token.pm"
sub aesKey {
	my $o = shift;
...
#line 124 "Condensation/CLI/Parser/Token.pm"
sub box {
	my $o = shift;
...
#line 139 "Condensation/CLI/Parser/Token.pm"
sub completeBox {
	my $o = shift;
...
#line 144 "Condensation/CLI/Parser/Token.pm"
sub boxLabel {
	my $o = shift;
...
#line 151 "Condensation/CLI/Parser/Token.pm"
...
#line 157 "Condensation/CLI/Parser/Token.pm"
sub file {
	my $o = shift;
...
#line 164 "Condensation/CLI/Parser/Token.pm"
sub completeFile {
	my $o = shift;
...
#line 187 "Condensation/CLI/Parser/Token.pm"
sub filename {
	my $o = shift;
...
#line 192 "Condensation/CLI/Parser/Token.pm"
sub folder {
	my $o = shift;
...
#line 199 "Condensation/CLI/Parser/Token.pm"
sub completeFolder {
	my $o = shift;
...
#line 217 "Condensation/CLI/Parser/Token.pm"
sub foldername {
	my $o = shift;
...
#line 222 "Condensation/CLI/Parser/Token.pm"
sub group {
	my $o = shift;
...
#line 227 "Condensation/CLI/Parser/Token.pm"
sub completeGroup {
	my $o = shift;
...
#line 233 "Condensation/CLI/Parser/Token.pm"
sub hash {
	my $o = shift;
...
#line 244 "Condensation/CLI/Parser/Token.pm"
sub completeHash {
	my $o = shift;
...
#line 259 "Condensation/CLI/Parser/Token.pm"
sub keyPair {
	my $o = shift;
...
#line 277 "Condensation/CLI/Parser/Token.pm"
sub completeKeyPair {
	my $o = shift;
...
#line 288 "Condensation/CLI/Parser/Token.pm"
sub label {
	my $o = shift;
...
#line 294 "Condensation/CLI/Parser/Token.pm"
sub completeLabel {
	my $o = shift;
...
#line 302 "Condensation/CLI/Parser/Token.pm"
sub object {
	my $o = shift;
...
#line 318 "Condensation/CLI/Parser/Token.pm"
sub completeObject {
	my $o = shift;
...
#line 323 "Condensation/CLI/Parser/Token.pm"
sub objectFile {
	my $o = shift;
...
#line 335 "Condensation/CLI/Parser/Token.pm"
...
#line 340 "Condensation/CLI/Parser/Token.pm"
sub actorGroup {
	my $o = shift;
...
#line 356 "Condensation/CLI/Parser/Token.pm"
sub onLoadActorGroupVerifyStore {
	my $o = shift;
	my $storeUrl = shift;
	 $o->{actor}->storeForUrl($storeUrl); }

#line 358 "Condensation/CLI/Parser/Token.pm"
...
#line 368 "Condensation/CLI/Parser/Token.pm"
sub port {
	my $o = shift;
...
#line 374 "Condensation/CLI/Parser/Token.pm"
...
#line 383 "Condensation/CLI/Parser/Token.pm"
sub directStoreUrl {
	my $o = shift;
...
#line 392 "Condensation/CLI/Parser/Token.pm"
sub store {
	my $o = shift;
...
#line 397 "Condensation/CLI/Parser/Token.pm"
...
#line 415 "Condensation/CLI/Parser/Token.pm"
...
#line 430 "Condensation/CLI/Parser/Token.pm"
sub completeUrl {
	my $o = shift;
...
#line 438 "Condensation/CLI/Parser/Token.pm"
sub text {
	my $o = shift;
...
#line 442 "Condensation/CLI/Parser/Token.pm"
sub user {
	my $o = shift;
...
#line 447 "Condensation/CLI/Parser/Token.pm"
sub completeUser {
	my $o = shift;
...
#line 453 "Condensation/CLI/Parser/Token.pm"
sub warning {
	my $o = shift;
...
#line 1 "Condensation/Actors/PrivateBoxReader.pm"
# Reads the private box of an actor.
package CDS::PrivateBoxReader;

#line 3 "Condensation/Actors/PrivateBoxReader.pm"
sub new {
	my $class = shift;
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
	my $store = shift;
...
#line 16 "Condensation/Actors/PrivateBoxReader.pm"
sub read {
	my $o = shift;
...
#line 86 "Condensation/Actors/PrivateBoxReader.pm"
sub invalid {
	my $o = shift;
	my $entry = shift;
	my $reason = shift;
...
#line 1 "Condensation/Actors/PrivateRoot.pm"
...
#line 21 "Condensation/Actors/PrivateRoot.pm"
sub addDataHandler {
	my $o = shift;
	my $label = shift;
	my $dataHandler = shift;
...
#line 25 "Condensation/Actors/PrivateRoot.pm"
sub removeDataHandler {
	my $o = shift;
	my $label = shift;
	my $dataHandler = shift;
...
#line 33 "Condensation/Actors/PrivateRoot.pm"
sub procure {
	my $o = shift;
	my $interval = shift;
...
#line 43 "Condensation/Actors/PrivateRoot.pm"
...
#line 52 "Condensation/Actors/PrivateRoot.pm"
...
#line 59 "Condensation/Actors/PrivateRoot.pm"
sub dataChanged {
	my $o = shift;
...
#line 63 "Condensation/Actors/PrivateRoot.pm"
sub save {
	my $o = shift;
	my $entrustedKeys = shift;
...
#line 110 "Condensation/Actors/PrivateRoot.pm"
sub savingSucceeded {
	my $o = shift;
...
#line 125 "Condensation/Actors/PrivateRoot.pm"
sub savingFailed {
	my $o = shift;
	my $missing = shift;
		# private
...
#line 1 "Condensation/Actors/PublicKey.pm"
# A public key of somebody.
package CDS::PublicKey;

#line 3 "Condensation/Actors/PublicKey.pm"
sub fromObject {
	my $class = shift;
	my $object = shift; die 'wrong type '.ref($object).' for $object' if defined $object && ref $object ne 'CDS::Object';
...
#line 1 "Condensation/Actors/PublicKeyCache.pm"
...
#line 8 "Condensation/Actors/PublicKeyCache.pm"
sub add {
	my $o = shift;
	my $publicKey = shift; die 'wrong type '.ref($publicKey).' for $publicKey' if defined $publicKey && ref $publicKey ne 'CDS::PublicKey';
...
#line 14 "Condensation/Actors/PublicKeyCache.pm"
sub get {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
...
#line 20 "Condensation/Actors/PublicKeyCache.pm"
sub deleteOldest {
	my $o = shift;
		# private
...
#line 1 "Condensation/Stores/PutTree.pm"
package CDS::PutTree;
...
#line 10 "Condensation/Stores/PutTree.pm"
sub put {
	my $o = shift;
	my $hash = shift // return; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
...
#line 1 "Condensation/Actors/ReceivedMessage.pm"
...
#line 21 "Condensation/Actors/ReceivedMessage.pm"
...
#line 25 "Condensation/Actors/ReceivedMessage.pm"
sub skip {
	my $o = shift;
...
#line 1 "Condensation/Serialization/Record.pm"
...
#line 5 "Condensation/Serialization/Record.pm"
sub fromObject {
	my $class = shift;
...
#line 11 "Condensation/Serialization/Record.pm"
sub new {
	my $class = shift;
	my $bytes = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
...
#line 28 "Condensation/Serialization/Record.pm"
sub addText {
	my $o = shift;
	my $value = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
...
#line 1 "Condensation/Serialization/RecordReader.pm"
...
#line 12 "Condensation/Serialization/RecordReader.pm"
sub readChildren {
	my $o = shift;
	my $record = shift; die 'wrong type '.ref($record).' for $record' if defined $record && ref $record ne 'CDS::Record';
...
#line 31 "Condensation/Serialization/RecordReader.pm"
sub use {
	my $o = shift;
	my $length = shift;
...
#line 39 "Condensation/Serialization/RecordReader.pm"
sub readUnsigned8 {
	my $o = shift;
...
#line 1 "Condensation/Serialization/RecordWriter.pm"
...
#line 9 "Condensation/Serialization/RecordWriter.pm"
sub header {
	my $o = shift;
	 pack('L>', $o->{hashesCount}).$o->{hashes} }
sub data { shift->{data} }

#line 12 "Condensation/Serialization/RecordWriter.pm"
sub writeChildren {
	my $o = shift;
	my $record = shift; die 'wrong type '.ref($record).' for $record' if defined $record && ref $record ne 'CDS::Record';
...
#line 20 "Condensation/Serialization/RecordWriter.pm"
sub writeNode {
	my $o = shift;
	my $record = shift; die 'wrong type '.ref($record).' for $record' if defined $record && ref $record ne 'CDS::Record';
...
#line 40 "Condensation/Serialization/RecordWriter.pm"
sub writeUnsigned8 {
	my $o = shift;
	my $value = shift;
	 $o->{data} .= pack('C', $value) }
...
#line 44 "Condensation/Serialization/RecordWriter.pm"
sub writeBytes {
	my $o = shift;
	my $bytes = shift;
...
#line 49 "Condensation/Serialization/RecordWriter.pm"
sub addHash {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
...
#line 1 "Condensation/Actors/Source.pm"
package CDS::Source;
...
#line 17 "Condensation/Actors/Source.pm"
sub keep {
	my $o = shift;
...
#line 26 "Condensation/Actors/Source.pm"
sub discard {
	my $o = shift;
...
#line 1 "Condensation/Stores/SplitStore.pm"
# A store mapping objects and accounts to a group of stores.
package CDS::SplitStore;

use parent -norequire, 'CDS::Store';

#line 4 "Condensation/Stores/SplitStore.pm"
sub new {
	my $class = shift;
	my $key = shift;
...
#line 17 "Condensation/Stores/SplitStore.pm"
sub assignAccounts {
	my $o = shift;
	my $fromIndex = shift;
	my $toIndex = shift;
...
#line 23 "Condensation/Stores/SplitStore.pm"
sub assignObjects {
	my $o = shift;
	my $fromIndex = shift;
	my $toIndex = shift;
...
#line 29 "Condensation/Stores/SplitStore.pm"
sub objectStore {
	my $o = shift;
	my $index = shift;
...
#line 36 "Condensation/Stores/SplitStore.pm"
sub storeIndex {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
...
#line 46 "Condensation/Stores/SplitStore.pm"
sub get {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 51 "Condensation/Stores/SplitStore.pm"
sub put {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $object = shift; die 'wrong type '.ref($object).' for $object' if defined $object && ref $object ne 'CDS::Object';
...
#line 56 "Condensation/Stores/SplitStore.pm"
sub book {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 61 "Condensation/Stores/SplitStore.pm"
sub list {
	my $o = shift;
	my $accountHash = shift; die 'wrong type '.ref($accountHash).' for $accountHash' if defined $accountHash && ref $accountHash ne 'CDS::Hash';
	my $boxLabel = shift;
...
#line 66 "Condensation/Stores/SplitStore.pm"
sub add {
	my $o = shift;
	my $accountHash = shift; die 'wrong type '.ref($accountHash).' for $accountHash' if defined $accountHash && ref $accountHash ne 'CDS::Hash';
	my $boxLabel = shift;
...
#line 71 "Condensation/Stores/SplitStore.pm"
sub remove {
	my $o = shift;
	my $accountHash = shift; die 'wrong type '.ref($accountHash).' for $accountHash' if defined $accountHash && ref $accountHash ne 'CDS::Hash';
	my $boxLabel = shift;
...
#line 76 "Condensation/Stores/SplitStore.pm"
sub modify {
	my $o = shift;
	my $modifications = shift;
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 1 "Condensation/Stores/Store.pm"
# General
# sub id($o)				# () => String
package CDS::Store;
...
#line 1 "Condensation/Stores/StoreModifications.pm"
...
#line 13 "Condensation/Stores/StoreModifications.pm"
sub isEmpty {
	my $o = shift;
...
#line 20 "Condensation/Stores/StoreModifications.pm"
sub put {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $object = shift; die 'wrong type '.ref($object).' for $object' if defined $object && ref $object ne 'CDS::Object';
...
#line 24 "Condensation/Stores/StoreModifications.pm"
sub add {
	my $o = shift;
	my $accountHash = shift; die 'wrong type '.ref($accountHash).' for $accountHash' if defined $accountHash && ref $accountHash ne 'CDS::Hash';
	my $boxLabel = shift;
...
#line 29 "Condensation/Stores/StoreModifications.pm"
sub remove {
	my $o = shift;
	my $accountHash = shift; die 'wrong type '.ref($accountHash).' for $accountHash' if defined $accountHash && ref $accountHash ne 'CDS::Hash';
	my $boxLabel = shift;
...
#line 12 "Condensation/Actors/StreamCache.pm"
sub removeObsolete {
	my $o = shift;
...
#line 21 "Condensation/Actors/StreamCache.pm"
sub readStreamHead {
	my $o = shift;
	my $head = shift;
...
#line 79 "Condensation/Actors/StreamCache.pm"
sub invalid {
	my $o = shift;
	my $head = shift;
	my $reason = shift;
...
#line 1 "Condensation/Actors/StreamHead.pm"
...
#line 22 "Condensation/Actors/StreamHead.pm"
sub stillInUse {
	my $o = shift;
...
#line 25 "Condensation/CLI/UI.pm"
sub pushIndent {
	my $o = shift;
...
#line 31 "Condensation/CLI/UI.pm"
sub popIndent {
	my $o = shift;
...
#line 37 "Condensation/CLI/UI.pm"
sub valueIndent {
	my $o = shift;
	my $width = shift;
...
#line 43 "Condensation/CLI/UI.pm"
sub print {
	my $o = shift;
...
#line 48 "Condensation/CLI/UI.pm"
sub raw {
	my $o = shift;
...
#line 58 "Condensation/CLI/UI.pm"
sub space {
	my $o = shift;
...
#line 111 "Condensation/CLI/UI.pm"
sub span {
	my $o = shift;
	 CDS::UI::Span->new(@_) }

#line 113 "Condensation/CLI/UI.pm"
sub bold {
	my $o = shift;
...
#line 119 "Condensation/CLI/UI.pm"
sub underlined {
	my $o = shift;
...
#line 125 "Condensation/CLI/UI.pm"
sub foreground {
	my $o = shift;
	my $foreground = shift;
...
#line 131 "Condensation/CLI/UI.pm"
sub background {
	my $o = shift;
	my $background = shift;
...
#line 137 "Condensation/CLI/UI.pm"
sub red {
	my $o = shift;
...
#line 145 "Condensation/CLI/UI.pm"
sub darkBold {
	my $o = shift;
...
#line 154 "Condensation/CLI/UI.pm"
sub title {
	my $o = shift;
	 $o->line($o->bold(@_)) }

#line 156 "Condensation/CLI/UI.pm"
sub left {
	my $o = shift;
	my $width = shift;
	my $text = shift;
...
#line 161 "Condensation/CLI/UI.pm"
sub right {
	my $o = shift;
	my $width = shift;
	my $text = shift;
...
#line 166 "Condensation/CLI/UI.pm"
sub keyValue {
	my $o = shift;
	my $key = shift;
	my $firstLine = shift;
...
#line 176 "Condensation/CLI/UI.pm"
sub command {
	my $o = shift;
	 $o->line($o->bold(@_)) }

#line 178 "Condensation/CLI/UI.pm"
sub verbose {
	my $o = shift;
	 $o->line($o->foreground(45, @_)) if $o->{verbose} }

#line 180 "Condensation/CLI/UI.pm"
sub pGreen {
	my $o = shift;
...
#line 185 "Condensation/CLI/UI.pm"
sub pOrange {
	my $o = shift;
...
#line 190 "Condensation/CLI/UI.pm"
sub pRed {
	my $o = shift;
...
#line 200 "Condensation/CLI/UI.pm"
sub warning {
	my $o = shift;
...
#line 206 "Condensation/CLI/UI.pm"
sub error {
	my $o = shift;
...
#line 218 "Condensation/CLI/UI.pm"
sub a {
	my $o = shift;
	 $o->underlined(@_) }
...
#line 222 "Condensation/CLI/UI.pm"
sub niceBytes {
	my $o = shift;
	my $bytes = shift;
	my $maxLength = shift;
...
#line 229 "Condensation/CLI/UI.pm"
sub niceFileSize {
	my $o = shift;
	my $fileSize = shift;
...
#line 239 "Condensation/CLI/UI.pm"
...
#line 244 "Condensation/CLI/UI.pm"
sub niceDateTime {
	my $o = shift;
	my $time = shift // time() * 1000;
...
#line 249 "Condensation/CLI/UI.pm"
sub niceDate {
	my $o = shift;
	my $time = shift // time() * 1000;
...
#line 254 "Condensation/CLI/UI.pm"
sub niceTime {
	my $o = shift;
	my $time = shift // time() * 1000;
...
#line 261 "Condensation/CLI/UI.pm"
sub record {
	my $o = shift;
	my $record = shift; die 'wrong type '.ref($record).' for $record' if defined $record && ref $record ne 'CDS::Record';
	my $storeUrl = shift;
...
#line 263 "Condensation/CLI/UI.pm"
sub recordChildren {
	my $o = shift;
	my $record = shift; die 'wrong type '.ref($record).' for $record' if defined $record && ref $record ne 'CDS::Record';
	my $storeUrl = shift;
...
#line 269 "Condensation/CLI/UI.pm"
sub selector {
	my $o = shift;
	my $selector = shift; die 'wrong type '.ref($selector).' for $selector' if defined $selector && ref $selector ne 'CDS::Selector';
	my $rootLabel = shift;
...
#line 290 "Condensation/CLI/UI.pm"
...
#line 296 "Condensation/CLI/UI.pm"
sub hexDump {
	my $o = shift;
	my $bytes = shift;
	 CDS::UI::HexDump->new($o, $bytes) }

#line 1 "Condensation/CLI/UI/HexDump.pm"
...
#line 8 "Condensation/CLI/UI/HexDump.pm"
sub changeStyle {
	my $o = shift;
...
#line 12 "Condensation/CLI/UI/HexDump.pm"
sub styleHashList {
	my $o = shift;
	my $offset = shift;
...
#line 39 "Condensation/CLI/UI/HexDump.pm"
sub styleRecord {
	my $o = shift;
	my $offset = shift;
...
#line 96 "Condensation/CLI/UI/HexDump.pm"
sub display {
	my $o = shift;
...
#line 1 "Condensation/CLI/UI/ProgressStore.pm"
package CDS::UI::ProgressStore;

use parent -norequire, 'CDS::Store';

#line 3 "Condensation/CLI/UI/ProgressStore.pm"
sub new {
	my $class = shift;
	my $store = shift;
	my $url = shift;
...
#line 15 "Condensation/CLI/UI/ProgressStore.pm"
sub id {
	my $o = shift;
	 'Progress'."\n  ".$o->{store}->id }
...
#line 19 "Condensation/CLI/UI/ProgressStore.pm"
sub get {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 24 "Condensation/CLI/UI/ProgressStore.pm"
sub book {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 29 "Condensation/CLI/UI/ProgressStore.pm"
sub put {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $object = shift; die 'wrong type '.ref($object).' for $object' if defined $object && ref $object ne 'CDS::Object';
...
#line 36 "Condensation/CLI/UI/ProgressStore.pm"
sub list {
	my $o = shift;
	my $accountHash = shift; die 'wrong type '.ref($accountHash).' for $accountHash' if defined $accountHash && ref $accountHash ne 'CDS::Hash';
	my $boxLabel = shift;
...
#line 41 "Condensation/CLI/UI/ProgressStore.pm"
sub add {
	my $o = shift;
	my $accountHash = shift; die 'wrong type '.ref($accountHash).' for $accountHash' if defined $accountHash && ref $accountHash ne 'CDS::Hash';
	my $boxLabel = shift;
...
#line 46 "Condensation/CLI/UI/ProgressStore.pm"
sub remove {
	my $o = shift;
	my $accountHash = shift; die 'wrong type '.ref($accountHash).' for $accountHash' if defined $accountHash && ref $accountHash ne 'CDS::Hash';
	my $boxLabel = shift;
...
#line 51 "Condensation/CLI/UI/ProgressStore.pm"
sub modify {
	my $o = shift;
	my $modifications = shift;
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 12 "Condensation/CLI/UI/Record.pm"
sub record {
	my $o = shift;
	my $record = shift; die 'wrong type '.ref($record).' for $record' if defined $record && ref $record ne 'CDS::Record';
	my $context = shift;
...
#line 45 "Condensation/CLI/UI/Record.pm"
sub hexValue {
	my $o = shift;
	my $bytes = shift;
...
#line 51 "Condensation/CLI/UI/Record.pm"
sub guessValue {
	my $o = shift;
	my $bytes = shift;
...
#line 1 "Condensation/CLI/UI/Span.pm"
package CDS::UI::Span;
...
#line 7 "Condensation/CLI/UI/Span.pm"
sub printTo {
	my $o = shift;
	my $ui = shift;
	my $parent = shift;
...
#line 51 "Condensation/CLI/UI/Span.pm"
sub wordWrap {
	my $o = shift;
	my $state = shift;
...
#line 4 "Condensation/UnionList/UnionList.pm"
sub new {
	my $class = shift;
	my $privateRoot = shift;
	my $label = shift;
...
#line 25 "Condensation/UnionList/UnionList.pm"
sub get {
	my $o = shift;
	my $id = shift;
	 $o->{items}->{$id} }

#line 27 "Condensation/UnionList/UnionList.pm"
sub getOrCreate {
	my $o = shift;
	my $id = shift;
...
#line 38 "Condensation/UnionList/UnionList.pm"
sub forget {
	my $o = shift;
	my $id = shift;
...
#line 44 "Condensation/UnionList/UnionList.pm"
sub forgetItem {
	my $o = shift;
	my $item = shift;
...
#line 51 "Condensation/UnionList/UnionList.pm"
sub addDataTo {
	my $o = shift;
	my $record = shift; die 'wrong type '.ref($record).' for $record' if defined $record && ref $record ne 'CDS::Record';
...
#line 57 "Condensation/UnionList/UnionList.pm"
sub mergeData {
	my $o = shift;
	my $record = shift; die 'wrong type '.ref($record).' for $record' if defined $record && ref $record ne 'CDS::Record';
...
#line 66 "Condensation/UnionList/UnionList.pm"
sub mergeExternalData {
	my $o = shift;
	my $store = shift;
	my $record = shift; die 'wrong type '.ref($record).' for $record' if defined $record && ref $record ne 'CDS::Record';
...
#line 90 "Condensation/UnionList/UnionList.pm"
sub merge {
	my $o = shift;
...
#line 103 "Condensation/UnionList/UnionList.pm"
sub read {
	my $o = shift;
...
#line 140 "Condensation/UnionList/UnionList.pm"
sub hasChanges {
	my $o = shift;
	 $o->{changes}->{count} > 0 }

#line 142 "Condensation/UnionList/UnionList.pm"
sub save {
	my $o = shift;
...
#line 1 "Condensation/UnionList/UnionList/Item.pm"
...
#line 13 "Condensation/UnionList/UnionList/Item.pm"
sub setPart {
	my $o = shift;
	my $part = shift;
...
#line 1 "Condensation/UnionList/UnionList/Part.pm"
...
#line 2 "Condensation/Actors/Unsaved.pm"
package CDS::Unsaved;

use parent -norequire, 'CDS::Store';

#line 4 "Condensation/Actors/Unsaved.pm"
sub new {
	my $class = shift;
	my $store = shift;
...
#line 17 "Condensation/Actors/Unsaved.pm"
sub isSaving {
	my $o = shift;
	 defined $o->{savingState} }

#line 19 "Condensation/Actors/Unsaved.pm"
sub startSaving {
	my $o = shift;
...
#line 25 "Condensation/Actors/Unsaved.pm"
sub savingDone {
	my $o = shift;
...
#line 30 "Condensation/Actors/Unsaved.pm"
sub savingFailed {
	my $o = shift;
...
#line 38 "Condensation/Actors/Unsaved.pm"
sub id {
	my $o = shift;
	 'Unsaved'."\n".unpack('H*', CDS->randomBytes(16))."\n".$o->{store}->id }

#line 40 "Condensation/Actors/Unsaved.pm"
sub get {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 52 "Condensation/Actors/Unsaved.pm"
sub book {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $keyPair = shift; die 'wrong type '.ref($keyPair).' for $keyPair' if defined $keyPair && ref $keyPair ne 'CDS::KeyPair';
...
#line 56 "Condensation/Actors/Unsaved.pm"
sub put {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $object = shift; die 'wrong type '.ref($object).' for $object' if defined $object && ref $object ne 'CDS::Object';
...
#line 60 "Condensation/Actors/Unsaved.pm"
sub list {
	my $o = shift;
	my $accountHash = shift; die 'wrong type '.ref($accountHash).' for $accountHash' if defined $accountHash && ref $accountHash ne 'CDS::Hash';
	my $boxLabel = shift;
...
#line 64 "Condensation/Actors/Unsaved.pm"
sub modify {
	my $o = shift;
	my $additions = shift;
	my $removals = shift;
...
#line 1 "Condensation/Actors/Unsaved/State.pm"
...
#line 13 "Condensation/Actors/Unsaved/State.pm"
sub addObject {
	my $o = shift;
	my $hash = shift; die 'wrong type '.ref($hash).' for $hash' if defined $hash && ref $hash ne 'CDS::Hash';
	my $object = shift; die 'wrong type '.ref($object).' for $object' if defined $object && ref $object ne 'CDS::Object';
...
#line 17 "Condensation/Actors/Unsaved/State.pm"
sub addMergedSource {
	my $o = shift;
...
#line 21 "Condensation/Actors/Unsaved/State.pm"
...
#line 25 "Condensation/Actors/Unsaved/State.pm"
sub merge {
	my $o = shift;
	my $state = shift;
